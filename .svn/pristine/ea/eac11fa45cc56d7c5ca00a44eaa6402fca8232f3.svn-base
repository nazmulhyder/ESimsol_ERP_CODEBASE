...
{
    public class rptDrawingPrintDoc
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintHeaderTwo()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("DRAWING PRODUCTION", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
        ...
        private void PrintBody()
        {
            ...
            oPdfPTable.SetWidths(new float[] { 20f, 80f, 120f, 120f, 80f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 80f });
            ...
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "No Of Frame", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ...
            oPdfPTable.SetWidths(new float[] { 20f, 80f, 120f, 120f, 80f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 80f });
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Drawing Running", 0, oPdfPTable.NumberOfColumns, Element.ALIGN_LEFT, BaseColor.WHITE, false, 0, _oFontStyleBold);
            oPdfPTable.CompleteRow();
            ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
            ...
            oPdfPTable.CompleteRow();
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Drawing Complete", 0, oPdfPTable.NumberOfColumns, Element.ALIGN_LEFT, BaseColor.WHITE, false, 0, _oFontStyleBold);
            oPdfPTable.CompleteRow();
            ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
        ...
        {            
            ...
            double nQty = 0, nWarpBeamLen = 0, nNoOfFrame = 0, nTotalFrame = 0, nTotalEnds = 0, nTotalBeamLen = 0;
            string sDia = "";
            ...
            foreach (var oMachine in oMachines)
            {
                ...
                foreach (var oItem1 in oFabricBatchs)
                {
                    ...
                    nWarpBeam = _oFabricBatchProductionBeams.Where(x => x.FBID == oItem1.FBID && x.IsDrawing == (int)EnumFabricBatchState.DrawingIn).Count();
                    //nWarpBeamLen = _oFabricBatchProductionBeams.Where(x => x.FBID == oItem1.FBID).Sum(x => x.QtyInMtr);
                    nWarpBeamLen = _oFabricBatchProductionBeams.Where(x => x.FBID == oItem1.FBID && x.IsDrawing == (int)EnumFabricBatchState.DrawingIn).Sum(x => x.QtyInMtr);
