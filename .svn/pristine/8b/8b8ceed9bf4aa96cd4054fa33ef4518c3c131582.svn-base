...
{
    public class rptProformaInvoiceList
    {
        #region Declaration
        Document _oDocument;
        ...
        {
            _oProformaInvoices = oProformaInvoice.ProformaInvoiceList;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Proforma Invoice List", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Colspan = 10;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
