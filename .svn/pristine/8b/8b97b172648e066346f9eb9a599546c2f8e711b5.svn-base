...
namespace ESimSol.Reports
{
    ...
    public class rptVoucherList
    {
        ...
        double _nSumVoucherAmount = 0;
        string _sMessage = "";
       
        #endregion

        public byte[] PrepareReport(Voucher oVoucher, string sMessage)
        {
            _oVouchers = oVoucher.VoucherList;
            ...
            _oDocument.Open();
                                            //SL No,    Voucher No, Voucher Name,   Narration,  Date,   Authorized By,  Amount,Con. Rate,   Amount
            _oPdfPTable.SetWidths(new float[] { 30f,    86f,        86f,            176f,       56f,    86f,            76f,        76f,    76f });
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Voucher Name", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Con. Rate (" + _oCompany.CurrencyName + ")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Amount ("+_oCompany.CurrencyName+")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);           
            _oPdfPTable.CompleteRow();
            ...
            foreach (Voucher oItem in _oVouchers)
            {
                nCount++;
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.AuthorizedByName, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.CUSymbol + " " + oItem.VoucherAmountInString, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oItem.CRate), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oItem.TotalAmount), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                _nSumVoucherAmount = _nSumVoucherAmount + oItem.TotalAmount;
                _oPdfPTable.CompleteRow();
            }
            ...
            _oPdfPCell.Border = 0; _oPdfPCell.Colspan = 8; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nSumVoucherAmount), _oFontStyle));
