...
namespace ESimSol.BusinessObjects
{
    public class DateDifference
    {
        ...
        public DateDifference(DateTime d1, DateTime d2)
        {
            ...
            //this.toDate=this.toDate.AddDays(1);
            /// 
            /// Day Calculation
            /// 
            increment = 0;
        ...
        public override string ToString()
        {
            ...
            string S = "";
            if(this.year>0){S+=this.year + "y,";}
            if(this.month>0){S+=this.month + "m,";}
            if(this.day>0){S+=this.day + "d,";}
            if (S != "") { S = S.Remove(S.Length - 1); } else { S = "0d"; }            
            return S;
