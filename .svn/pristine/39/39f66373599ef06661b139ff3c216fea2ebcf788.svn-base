...
namespace ESimSol.Reports
{
    public class rptSupplierOrder
    {
        ...
        public byte[] PrepareReport(PurchaseOrder oPurchaseOrder, Company oCompany, Contractor oContractor, BusinessUnit oBusinessUnit, List<SignatureSetup> oSignatureSetups)
        {
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Supplier Order", _oFontStyle));
        ...
        private void PrintHeader_Blank()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Supplier Order", _oFontStyle_UnLine));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.Colspan = 9;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("SO No", _oFontStyle_Bold));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseOrder.FullPONo, _oFontStyle));
            ...
            oPdfPTable.SetWidths(new float[] { 40f,60f, 160f, 85f, 50f, 70f, 80f, 80f });
            ...
            _oPdfPCell = new PdfPCell(new Phrase("PART NO", _oFontStyle_Bold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("DESCRIPTION OF GOODS", _oFontStyle_Bold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Vehicle Model", _oFontStyle_Bold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseOrder.CurrencySymbol + " " + Global.MillionFormat(nTotalValue), _oFontStyle_Bold));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseOrder.CurrencySymbol + " " + Global.MillionFormat(nTotalValue - _oPurchaseOrder.DiscountInAmount), _oFontStyle_Bold));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();

            _oPdfPCell = new PdfPCell(new Phrase("Amount In Word :  " + Global.AmountInWords(nTotalValue - _oPurchaseOrder.DiscountInAmount, _oPurchaseOrder.CurrencyBFDP, _oPurchaseOrder.CurrencyBADP), _oFontStyle));
