...
{
    public class rptDUReturnChallanDetails
    {
        #region Declaration
        int _nTotalColumn = 9;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<DUReturnChallan> oDUReturnChallans, List<DUReturnChallanDetail> oDUReturnChallanDetails, Company oCompany, bool bIsRateView)
        {
            _oDUReturnChallans = oDUReturnChallans;
            _oDUReturnChallanDetails = oDUReturnChallanDetails;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Return Challan Details", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            if (_oDUReturnChallans.Count > 0)
            {
                foreach (DUReturnChallan oItem in _oDUReturnChallans)
                {
                    ...
                    int nRowSpan = oTempDUReturnChallanDetails.Count();
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.DUReturnChallanNo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ReturnDateSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    if (oTempDUReturnChallanDetails.Count > 0)
                    {
                        foreach (DUReturnChallanDetail oItemDetail in oTempDUReturnChallanDetails)
                        {
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.OrderNo, _oFontStyle)); 
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.PINo, _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.ColorName, _oFontStyle));
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oDUReturnChallanDetails.Sum(x => x.Qty).ToString("#,##0.00"), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                if (_bIsRateView)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(_oDUReturnChallanDetails.Select(x=>(x.Qty*x.UnitPrice)).Sum().ToString("#,##0.00"), _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                }
