...
namespace ESimSol.Reports
{
    public class rptDayWiseAbsent
    {
        ...
        public byte[] PrepareReport(AttendanceDaily oAttendanceDaily)
        {
            ...
            sHeader = "Absent for " + oAttendanceDaily.ErrorMessage + " continuous days";
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 20f, 80f, 100f, 60f, 70f, 50f, 50f });
            #endregion
        ...
        private void PrintHeaderRow(AttendanceDaily oAtt)
        {

            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.BOLD);

            _oPdfPCell = new PdfPCell(new Phrase("Department : " + oAtt.DepartmentName, _oFontStyle)); _oPdfPCell.Border = 0; _oPdfPCell.Colspan = 7;
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Last Present", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintBody()
        {
            if (_oAttendanceDailys.Count <= 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase("There is no data to print !!", _oFontStyle)); _oPdfPCell.Colspan = 7; _oPdfPCell.Border = 0;
            ...
            else
            {
                ...
                while (_oAttendanceDailys.Count > 0)
                {
                    ...
                    oTempAttendanceDailys = _oAttendanceDailys.Where(x => x.DepartmentName == _oAttendanceDailys[0].DepartmentName).ToList();
                    PrintHeaderRow(oTempAttendanceDailys[0]);
                    PrintDailyAbsent(oTempAttendanceDailys);
                    _oAttendanceDailys.RemoveAll(x => x.DepartmentName == oTempAttendanceDailys[0].DepartmentName);
                }
            }

            _oPdfPCell = new PdfPCell(new Phrase(" ", _oFontStyle)); _oPdfPCell.Colspan = 7; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 30;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPTable.CompleteRow();
        }

        private void PrintDailyAbsent(List<AttendanceDaily> oAttendanceDailys)
        {
            ...
            foreach (AttendanceDaily oItem in oAttendanceDailys)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.LastAttendanceDateInString, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
