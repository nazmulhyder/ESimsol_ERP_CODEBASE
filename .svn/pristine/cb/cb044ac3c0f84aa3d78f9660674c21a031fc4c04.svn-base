...
{
    public class rptFabricExecutionOrderYarnReceives
    {
        #region Declaration
        int _nTotalColumn = 9;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<WYRequisition> oWYRequisitions, List<FabricExecutionOrderYarnReceive> oFabricExecutionOrderYarnReceives, Company oCompany)
        {
            _oWYRequisitions = oWYRequisitions;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Left Over Details", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            if (_oWYRequisitions.Count > 0)
            {
                foreach (WYRequisition oItem in _oWYRequisitions)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.IssueDateSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    if (oTempFabricExecutionOrderYarnReceives.Count > 0)
                    {
                        foreach (FabricExecutionOrderYarnReceive oItemDetail in oTempFabricExecutionOrderYarnReceives)
                        {
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.DispoNo, _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.ReceiveQty.ToString("#,##0.00"), _oFontStyle));
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oFabricExecutionOrderYarnReceives.Sum(x => x.ReceiveQty).ToString("#,##0.00"), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
