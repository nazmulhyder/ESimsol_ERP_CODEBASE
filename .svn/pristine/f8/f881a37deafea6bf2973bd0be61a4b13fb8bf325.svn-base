...
{
    public class rptDyeingOrderReportAll
    {
        #region Declaration
        ...
        public byte[] PrepareReport(List<DyeingOrderReport> oDyeingOrderReports, Company oCompany,BusinessUnit oBusinessUnit, string sDateRange)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 10f, 25f, 30f, 22f, 70f, 60f, 71f, 22f, 28f, 30f, 30f, 42f, 35f, 60f });
            #endregion
        ...
        private void ReporttHeader()
        {
            ...
            #region Proforma Invoice Heading Print
                ...
                sHeaderName = "Production Order Register";
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Buyer C. Person", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (DyeingOrderReport oItem in _oDyeingOrderReports)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.MBuyerName, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.UPriceSt, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.DONote, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nTotalQty.ToString() + _oDyeingOrderReports[0].MUName, _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
