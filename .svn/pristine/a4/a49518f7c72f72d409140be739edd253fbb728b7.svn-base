...
{
    public class rptSalarySheet_MAMIYAFormat
    {
        #region Declaration
        iTextSharp.text.Image _oImag;
        Document _oDocument;
        iTextSharp.text.Font _oFontStyle;
        PdfPTable _oPdfPTable=new PdfPTable(36);
        PdfPCell _oPdfPCell;
        ...
        public byte[] PrepareReport(EmployeeSalary_MAMIYA oEmployeeSalary_MAMIYA)
        {
            ...
            #region Page Setup
            _oDocument = new Document(new iTextSharp.text.Rectangle(1700, 1600), 0f, 0f, 0f, 0f);
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 20f, 35f, 120f, 85f, 50f, 50f, 50f, 45f, 45f, 55f, 40f, 40f, 40f, 50f, 40f, 40f, 40f, 40f, 50f, 45f, 40f, 50f, 50f, 50f, 50f, 55f, 45f, 40f, 40f, 40f, 40f, 40f, 40f, 40f, 45f, 55f });
            #endregion
        ...
        #region Report Body
        private void PrintHaedRow(EmployeeSalary_MAMIYA oES)
        {
            _oFontStyle = FontFactory.GetFont("Tahoma", 9f, iTextSharp.text.Font.BOLD);

            _oPdfPCell = new PdfPCell(new Phrase("Department:" + oES.DepartmentName, _oFontStyle)); _oPdfPCell.Border = 0; _oPdfPCell.Colspan = 36;
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Employee Information", _oFontStyle)); _oPdfPCell.Colspan = 4;
        ...
        double nBAsic_GT = 0;
        double nBAsic_Dept = 0;

        double nHRent_GT = 0;
        double nHRent_Dept = 0;
        ...
        double nAbsentHr_Sick_Dept = 0;

        double nAbsentHr_WOPay_GT = 0;
        double nAbsentHr_WOPay_Dept = 0;

        double nTotalAbsentAmount_GT = 0;
        double nTotalAbsentAmount_Dept = 0;

        double nEarnedPay_GT = 0;
        double nEarnedPay_Dept = 0;

        double nShiftAmount_GT = 0;
        double nShiftAmount_Dept = 0;

        double nOT_NHR_GT = 0;
        double nOT_NHR_Dept = 0;

        double nOT_HHR_GT = 0;
        double nOT_HHR_Dept = 0;

        double nFHOT_GT = 0;
        double nFHOT_Dept = 0;

        double nOTAmount_GT = 0;
        double nOTAmount_Dept = 0;

        double nAttendanceBonus_GT = 0;
        double nAttendanceBonus_Dept = 0;

        double nADJCR_GT = 0;
        double nADJCR_Dept = 0;

        double nOthAll_GT = 0;
        double nOthAll_Dept = 0;

        double nFB_GT = 0;
        double nFB_Dept = 0;

        double nMBill_GT = 0;
        double nMBill_Dept = 0;

        double nHolidayAll_GT = 0;
        double nHolidayAll_Dept = 0;

        double nGrossPay_GT = 0;
        double nGrossPay_Dept = 0;
        ...
        double nADJDR_GT = 0;
        double nADJDR_Dept = 0;

        double nRS_GT = 0;
        double nRS_Dept = 0;

        double nPLoan_GT = 0;
        double nPLoan_Dept = 0;

        double nTAX_GT = 0;
        double nTAX_Dept = 0;

        double nDeductionTotal_GT = 0;
        double nDeductionTotal_Dept = 0;

        double nFracretained_GT = 0;
        double nFracretained_Dept = 0;

        double nNetPay_GT = 0;
        double nNetPay_Dept = 0;
        private void PrintBody()
        {
            _oEmployeeSalary_MAMIYAs = _oEmployeeSalary_MAMIYAs.OrderBy(x => x.DepartmentName).ToList();
            while (_oEmployeeSalary_MAMIYAs.Count > 0)
            {
                List<EmployeeSalary_MAMIYA> oTempEmployeeSalary_MAMIYAs = new List<EmployeeSalary_MAMIYA>();
                oTempEmployeeSalary_MAMIYAs = _oEmployeeSalary_MAMIYAs.Where(x => x.DepartmentName == _oEmployeeSalary_MAMIYAs[0].DepartmentName).ToList();
                PrintSalarySheet(oTempEmployeeSalary_MAMIYAs);
                DepartmentWiseTotal();
                InitializeDeptWise();
                _oEmployeeSalary_MAMIYAs.RemoveAll(x => x.DepartmentName == oTempEmployeeSalary_MAMIYAs[0].DepartmentName);
            }
            GT();
            DenominationOfNotes();
            Footer();
        ...
        {
            nCount = 0;
            PrintHaedRow(oEmployeeSalary_MAMIYAs[0]);
            ...
            foreach (EmployeeSalary_MAMIYA oEmpSalaryItem in oEmployeeSalary_MAMIYAs)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oEmpSalaryItem.DateOfJoinInString, _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                nBAsic_Dept += oEmpSalaryItem.Basic;
                ...
                nHRent_Dept += oEmpSalaryItem.HRent;
                ...
                nMed_Dept += oEmpSalaryItem.Med;

                _oPdfPCell = new PdfPCell(new Phrase(oEmpSalaryItem.Conveyance > 0 ? Global.MillionFormat(oEmpSalaryItem.Conveyance) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                
                nCONV_GT += oEmpSalaryItem.Conveyance;
                nCONV_Dept += oEmpSalaryItem.Conveyance;
                ...
                nGrossSalary_Dept += oEmpSalaryItem.GrossSalary;
                ...
                nAbsentHr_Sick_Dept += oEmpSalaryItem.AbsentHr_Sick;
                ...
                nAbsentHr_WOPay_Dept += oEmpSalaryItem.AbsentHr_WOPay;
                ...
                nTotalAbsentAmount_Dept += oEmpSalaryItem.TotalAbsentAmount;
                ...
                nEarnedPay_Dept += oEmpSalaryItem.EarnedPay;
                ...
                nShiftAmount_Dept += oEmpSalaryItem.ShiftAmount;
                ...
                nOT_NHR_Dept += oEmpSalaryItem.OT_NHR_HR;
                ...
                nOT_HHR_Dept += oEmpSalaryItem.OT_HHR_HR;
                ...
                nFHOT_Dept += oEmpSalaryItem.FHOT_HR;
                ...
                nOTAmount_Dept += oEmpSalaryItem.OTAmount;
                ...
                nAttendanceBonus_Dept += oEmpSalaryItem.AttendanceBonus;
                ...
                nADJCR_Dept += oEmpSalaryItem.ADJCR;

                _oPdfPCell = new PdfPCell(new Phrase(oEmpSalaryItem.OtherAll > 0?Global.MillionFormat(oEmpSalaryItem.OtherAll):"-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                nOthAll_GT += oEmpSalaryItem.OtherAll;
                nOthAll_Dept += oEmpSalaryItem.OtherAll;
                ...
                nMBill_Dept += oEmpSalaryItem.MobileBill;
                ...
                nHolidayAll_Dept += oEmpSalaryItem.HolidayAll;
                ...
                nGrossPay_Dept += oEmpSalaryItem.GrossPay;
                ...
                nTRNS_Dept += oEmpSalaryItem.TRNS;
                ...
                nDORM_Dept += oEmpSalaryItem.DORM;
                ...
                nADJDR_Dept += oEmpSalaryItem.ADJDR;
                ...
                nPLoan_Dept += oEmpSalaryItem.PLoan;


                _oPdfPCell = new PdfPCell(new Phrase(oEmpSalaryItem.IncomeTax > 0 ? Global.MillionFormat(oEmpSalaryItem.IncomeTax) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                nTAX_GT += oEmpSalaryItem.IncomeTax;
                nTAX_Dept += oEmpSalaryItem.IncomeTax;
                ...
                nDeductionTotal_Dept += oEmpSalaryItem.DeductionTotal;
                ...
                nNetPay_Dept += oEmpSalaryItem.NetPay;
        ...
        public void DepartmentWiseTotal()
        {
            ...
            if (nBAsic_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nBAsic_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nMed_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nMed_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nCONV_Dept > 0?Global.MillionFormat(nCONV_Dept):"-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            

            if (nGrossSalary_Dept > 0)
            {
            ...
            if (nAbsentHr_Sick_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nAbsentHr_Sick_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nAbsentHr_WOPay_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nAbsentHr_WOPay_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nTotalAbsentAmount_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nTotalAbsentAmount_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nEarnedPay_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nEarnedPay_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nShiftAmount_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nShiftAmount_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nOT_NHR_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOT_NHR_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nOT_HHR_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOT_HHR_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nFHOT_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nFHOT_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nOTAmount_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOTAmount_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nAttendanceBonus_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nAttendanceBonus_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nADJCR_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nADJCR_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nOthAll_Dept > 0 ? Global.MillionFormat(nOthAll_Dept) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            
            if (nFB_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nFB_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nMBill_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nMBill_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nHolidayAll_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nHolidayAll_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nGrossPay_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nGrossPay_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nPF_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nPF_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nTRNS_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nTRNS_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nDORM_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nDORM_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nADV_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nADV_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nADJDR_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nADJDR_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nRS_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nRS_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nPLoan_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nPLoan_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nTAX_Dept > 0 ? Global.MillionFormat(nTAX_Dept) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
           
            if (nDeductionTotal_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nDeductionTotal_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            if (nNetPay_Dept > 0)
            {
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nNetPay_Dept), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            }
            else
            {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Colspan = 36; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 25;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
        }
        ...
        {
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 30; _oPdfPCell.Colspan = 36; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPTable.CompleteRow();

            _oFontStyle = FontFactory.GetFont("Tahoma", 9f, iTextSharp.text.Font.NORMAL);
            _oPdfPCell = new PdfPCell(new Phrase("Grand Total :", _oFontStyle)); _oPdfPCell.Colspan = 5; _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nOthAll_GT > 0 ? Global.MillionFormat(nOthAll_GT) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nTAX_GT > 0 ? Global.MillionFormat(nTAX_GT) : "-", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            //if (nFracretained_GT> 0)
            //{
            //    _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nFracretained_GT), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
            //    _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            //}
            //else
            //{
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Colspan = 36; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 30;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
        ...
        public void DenominationOfNotes()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Colspan = 36 - nColumnCount * 2 - 4; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();

            _oPdfPCell = new PdfPCell(new Phrase("Grand Total ->", _oFontStyle)); _oPdfPCell.Colspan = 4; _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            nNetAmount = nNetPay_GT;
            nColumnCount = 0;
            foreach (string sNote in S)
            {
                double nNote = Convert.ToDouble(sNote);
        ...
        public void Footer()
        {
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 50; _oPdfPCell.Colspan = 36; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Prepared By", _oFontStyle)); _oPdfPCell.Colspan = 12; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Checked By", _oFontStyle)); _oPdfPCell.Colspan = 12; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Colspan = 36; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 20;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void InitializeDeptWise()
        {
            ...
            nMed_Dept = 0;
            nGrossSalary_Dept = 0;
            nAbsentHr_Sick_Dept = 0;
            nAbsentHr_WOPay_Dept = 0;
            nTotalAbsentAmount_Dept = 0;
            nEarnedPay_Dept = 0;
            nShiftAmount_Dept = 0;
            nOT_NHR_Dept = 0;
            nOT_HHR_Dept = 0;
            ...
            nRS_Dept = 0;
            nPLoan_Dept = 0;
            nDeductionTotal_Dept = 0;
            nFracretained_Dept = 0;
            nNetPay_Dept = 0;
            nFB_Dept = 0;
            nMBill_Dept = 0;
            nHolidayAll_Dept = 0;
