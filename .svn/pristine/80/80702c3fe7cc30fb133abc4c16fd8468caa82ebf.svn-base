...
namespace ESimSol.Reports
{
    public class rptARSRegisters
    {
        ...
        public byte[] PrepareReport(List<AdjustmentRequisitionSlipRegister> oAdjustmentRequisitionSlipRegisters, Company oCompany, EnumReportLayout eReportLayout, string sDateRange)
        {
            _oAdjustmentRequisitionSlipRegisters = oAdjustmentRequisitionSlipRegisters;
            _oCompany = oCompany;
        ...
        private void PrintBodyProductWise()
        {
            ...
            double nInTotalQty = 0, nOutTotalQty = 0, nGrandInTotalQty = 0, nGrandOutTotalQty = 0 ;
            foreach (AdjustmentRequisitionSlipRegister oItem in _oAdjustmentRequisitionSlipRegisters)
            {
                if (sProductName != oItem.ProductName)
                {
                    ...
                    if (oPdfPTable.Rows.Count > 0)
                    {
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nInTotalQty), _oFontStyleBold));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                        _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nOutTotalQty), _oFontStyleBold));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        oPdfPTable.CompleteRow();
                        #endregion
                        ...
                        nInTotalQty = 0; nOutTotalQty = 0; nCount = 0;
                    }
                    #endregion
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("In Qty", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase("Out Qty", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.RequestedDateTimeInString, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.MUSymbol, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.InOutType == EnumInOutType.Receive ? Global.MillionFormatActualDigit(oItem.Qty) : "-", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.InOutType == EnumInOutType.Disburse ? Global.MillionFormatActualDigit(oItem.Qty) : "-", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                oPdfPTable.CompleteRow();
                ...
                if (oItem.InOutType == EnumInOutType.Receive)
                {
                    ...
                    nGrandInTotalQty = nGrandInTotalQty + oItem.Qty;
                }
                else
                {
                    nOutTotalQty = nOutTotalQty + oItem.Qty;
                    nGrandOutTotalQty = nGrandOutTotalQty + oItem.Qty;
                }
            }
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nGrandInTotalQty), _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nGrandOutTotalQty), _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
