...
namespace ESimSol.Reports
{
    ...
    public class rptSalarySheet_Final
    {
        #region Declaration
        ...
        public byte[] PrepareReport(EmployeeSalary oEmployeeSalary)
        {
            ...
            _oDocument.Open();
            //_oPdfPTable.SetWidths(new float[] { 20f, 252f, 130f, 70f, 90f, 75f, 80f, 70f, 60f, 70f, 70f, 65f, 65f, 77f, 62f, 70f });
            _oPdfPTable.SetWidths(new float[] { 20f, 240f, 110f, 70f, 93f, 95f, 80f, 70f, 70f, 70f, 60f, 70f, 60f, 65f, 60f, 65f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(" Final Salary Sheet", _oFontStyle));
            _oPdfPCell.Colspan = 16;
        ...
        //col-8
        double nOverTimeDepartmentWise_First = 0;
        double nOverTimeTotal_First = 0;
        //col-9
        double nOverTimeDepartmentWise_OT = 0;
        double nOverTimeTotal_OT = 0;
        //col-10
        double nOverTimeDepartmentWise_Final = 0;
        double nOverTimeTotal_Final = 0;
        //col-11
        ...
        private void PrintHaedRow(EmployeeSalary oES)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Department:" + oES.DepartmentName, _oFontStyle)); _oPdfPCell.Border = 0; _oPdfPCell.Colspan = 16;
            ...
            _oPdfPCell = new PdfPCell(new Phrase("OT(1)", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("OT(2)", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Rest Of OT", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (EmployeeSalary oEmpSalaryItem in oEmployeeSalarys)
            {
                ...
                foreach (Employee OEmpItem in _oEmployees)
                {
                    if (OEmpItem.EmployeeID == oEmpSalaryItem.EmployeeID)
                    {
                        ...
                        {
                            nEarnSalaryEmployeeWise = oEmpSalaryItem.NetAmount + nDeductionEmployeeWise;
                            nSalary = nEarnSalaryEmployeeWise - oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.TotalNoWorkDayAllowance - nAllowanceEmployeeWise;
                            //oEmpSalaryItem.ProductionAmount
                            //nEarnSalaryEmployeeWise = oEmpSalaryItem.ProductionAmount + oEmpSalaryItem.ProductionBonus + nAllowanceEmployeeWise + oEmpSalaryItem.TotalNoWorkDayAllowance + oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour+ oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour+oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour;
                            nSalaryDepartmentWise = nSalaryDepartmentWise + oEmpSalaryItem.ProductionAmount + oEmpSalaryItem.ProductionBonus;
                            _oPdfPCell = new PdfPCell(new Phrase("Pro.: " + Global.MillionFormat(oEmpSalaryItem.ProductionAmount) + "\nP.Bonus: " + Global.MillionFormat(oEmpSalaryItem.ProductionBonus), _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                        }
                        else
                        {
                            nEarnSalaryEmployeeWise = oEmpSalaryItem.NetAmount + nDeductionEmployeeWise;
                            nSalary = nEarnSalaryEmployeeWise - oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.TotalNoWorkDayAllowance - nAllowanceEmployeeWise;
                            //nSalary = oEmpSalaryItem.NetAmount - nAllowanceEmployeeWise - oEmpSalaryItem.TotalNoWorkDayAllowance - oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour - oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour + nDeductionEmployeeWise;
                            //nEarnSalaryEmployeeWise = nSalary + nAllowanceEmployeeWise + oEmpSalaryItem.TotalNoWorkDayAllowance + oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour + oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour + oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour;
                            nSalaryDepartmentWise = nSalaryDepartmentWise + nSalary;
                            _oPdfPCell = new PdfPCell(new Phrase("Salary: " + Global.MillionFormat(nSalary) /*+ "\nA. Bonus: " + Global.MillionFormat(nABonus)*/, _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                        }
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase("H: " +Global.MillionFormat(oEmpSalaryItem.OTHr_2ndPortion)+ "\nR: " + Global.MillionFormat(oEmpSalaryItem.OTRatePerHour )+ "\nA: " + Global.MillionFormat(oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour), _oFontStyle));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                        _oPdfPCell = new PdfPCell(new Phrase("H: " + Global.MillionFormat(oEmpSalaryItem.OTHr_Rest) + "\nR: " + Global.MillionFormat(oEmpSalaryItem.OTRatePerHour) + "\nA: " + Global.MillionFormat(oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour), _oFontStyle));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oEmpSalaryItem.NetAmount), _oFontStyle));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                nOverTimeDepartmentWise_First = nOverTimeDepartmentWise_First + oEmpSalaryItem.OTHour * oEmpSalaryItem.OTRatePerHour;
                nOverTimeDepartmentWise_OT = nOverTimeDepartmentWise_OT + oEmpSalaryItem.OTHr_2ndPortion * oEmpSalaryItem.OTRatePerHour;
                nOverTimeDepartmentWise_Final = nOverTimeDepartmentWise_Final + oEmpSalaryItem.OTHr_Rest * oEmpSalaryItem.OTRatePerHour;
                ...
                nNetSalaryDepartmentWise = nNetSalaryDepartmentWise + oEmpSalaryItem.NetAmount;

                nSalaryGTotal += nSalary;
                nAllowanceTotal += nAllowanceEmployeeWise;
                nNoWorkTotal = nNoWorkTotal + oEmpSalaryItem.TotalNoWorkDayAllowance;
                nOverTimeTotal_First = nOverTimeTotal_First + oEmpSalaryItem.OTHour;
                nOverTimeTotal_OT = nOverTimeTotal_OT + oEmpSalaryItem.OTHr_2ndPortion;
                nOverTimeTotal_Final = nOverTimeTotal_Final + oEmpSalaryItem.OTHr_Rest;
                ...
                nNetSalaryTotal = nNetSalaryTotal + oEmpSalaryItem.NetAmount;
        ...
        public void DepartmentWiseTotal()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeDepartmentWise_First), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeDepartmentWise_OT), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeDepartmentWise_Final), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 40; _oPdfPCell.Colspan = 16; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void Footer()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 20; _oPdfPCell.Colspan = 16; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nSalaryGTotal), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeTotal_First), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeTotal_OT), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nOverTimeTotal_Final), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Allowance", _oFontStyle)); _oPdfPCell.Colspan = 5;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Deduction", _oFontStyle)); _oPdfPCell.Colspan = 5;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Border = 0; _oPdfPCell.Rowspan = 5;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(ProductionGTTable()); _oPdfPCell.Colspan = 2; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(AllowanceGTTable(oESDs)); _oPdfPCell.Colspan = 5; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(DeductionGTTable(oESDs_Ded)); _oPdfPCell.Colspan = 5; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("____________________", _oFontStyle)); _oPdfPCell.Colspan = 5; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Recommended By", _oFontStyle)); _oPdfPCell.Colspan = 5; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public PdfPTable GetEmpOffical(Employee oEmp)
        {
            ...
            oPdfPTable1.SetWidths(new float[] { 45f, 48f, 87f });
        ...
        public PdfPTable GetAll_Table(int nEmpSalaryID)
        {
            ...
            oPdfPTable_All.SetWidths(new float[] { 70f, 50f });
            if (nAttBonus > 0)
            {
            ...
            //oPdfPCell_All = new PdfPCell(new Phrase("Others:", _oFontStyle)); oPdfPCell_All.Border = 0;
            //oPdfPCell_All.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell_All.BackgroundColor = BaseColor.WHITE; oPdfPTable_All.AddCell(oPdfPCell_All);

            //oPdfPCell_All = new PdfPCell(new Phrase(Global.MillionFormat(0.00), _oFontStyle)); oPdfPCell_All.Border = 0;
            //oPdfPCell_All.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell_All.BackgroundColor = BaseColor.WHITE; oPdfPTable_All.AddCell(oPdfPCell_All);
            //oPdfPTable_All.CompleteRow();
        ...
        public PdfPTable GetDeduction_Table(int nEmpSalaryID, double nRs)
        {
            ...
            //oPdfPCell_Deduction = new PdfPCell(new Phrase("Others:", _oFontStyle)); oPdfPCell_Deduction.Border = 0;
            //oPdfPCell_Deduction.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell_Deduction.BackgroundColor = BaseColor.WHITE; oPdfPTable_Deduction.AddCell(oPdfPCell_Deduction);

            //oPdfPCell_Deduction = new PdfPCell(new Phrase(Global.MillionFormat(0.00), _oFontStyle)); oPdfPCell_Deduction.Border = 0;
            //oPdfPCell_Deduction.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell_Deduction.BackgroundColor = BaseColor.WHITE; oPdfPTable_Deduction.AddCell(oPdfPCell_Deduction);
            //oPdfPTable_Deduction.CompleteRow();
        ...
        public void InitializeDeptWise()
        {
            ...
            nOverTimeDepartmentWise_First = 0;
            nOverTimeDepartmentWise_OT = 0;
            nOverTimeDepartmentWise_Final = 0;
