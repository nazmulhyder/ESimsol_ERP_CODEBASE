...
namespace ESimSol.Reports
{
    public class rptGUQCs
    {
        ...
        public byte[] PrepareReport(List<GUQC> oGUQCs, Company oCompany)
        {
            _oGUQCs = oGUQCs;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("QC List", _oFontStyle));
            _oPdfPCell.Colspan = _nTotalColumn;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            if (_oGUQCs.Count > 0)
            {
                foreach (GUQC oItem in _oGUQCs)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ApproveDateInString, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
