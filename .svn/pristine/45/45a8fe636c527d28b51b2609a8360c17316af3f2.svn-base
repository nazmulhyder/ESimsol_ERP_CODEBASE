...
namespace ESimSol.Reports
{
    ...
    public class rptOrderSheetList
    {
        #region Declaration
        Document _oDocument;
        ...
        double _nSumOrderSheetAmount = 0; double _nTotalQty = 0; bool bIsDifferentUnitExist = false, bIsDeffrentCurrencyExist = false;
        ...
        public byte[] PrepareReport(OrderSheet oOrderSheet)
        {
            ...
            _oPdfPTable.SetWidths(new float[] { 7f, 15f, 15f, 18f, 18f, 12f, 17f, 16f, 13f,15f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Order Sheet List", _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.FixedHeight = 30f; _oPdfPCell.Colspan = 10; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Party No", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
           ...
           _oPdfPCell = new PdfPCell(new Phrase("Market Person", _oFontStyle));
           _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
           ...
           int nCount = 0;
            ...
            foreach (OrderSheet oItem in _oOrderSheets)
            {
                nCount++;
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.PartyPONo, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
