...
{
    public class rptDUProductionYetToYarnView
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<DUProductionYetTo> oDUProductionYetTos, Company oCompany, BusinessUnit oBusinessUnit, int gOrderDate, DateTime D1, DateTime D2)
        {
            ...
            _oPdfPTable.SetWidths(new float[] { 30f, 40f, 142f, 70f, 70f, 70f, 70f, 70f, 70f, 70f, 70f, 70f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Production Status(Yarn View)", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Pending Pro." + "(" + _oDUProductionYetTos[0].MUName + ")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintGT()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Grand TOTAL", _oFontStyle)); _oPdfPCell.FixedHeight = RowHeight; _oPdfPCell.Colspan = 3;
