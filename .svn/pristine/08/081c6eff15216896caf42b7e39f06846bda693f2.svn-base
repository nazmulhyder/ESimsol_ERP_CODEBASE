...
namespace ESimSol.Reports
{
    ...
    public class rptProductionStepList
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(ProductionStep oProductionStep, Company oCompany)
        {
            _oProductionSteps = oProductionStep.ProductionStepList;
            _oCompany = oCompany;
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 55f, 440f, 90f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            #region ReportHeader
            _oPdfPCell = new PdfPCell(new Phrase("Production Step List", _oFontStyle));
            _oPdfPCell.Colspan = 3;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            foreach (ProductionStep oItem in _oProductionSteps)
            {
                nCount++;
