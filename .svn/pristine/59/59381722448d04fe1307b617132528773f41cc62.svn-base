...
namespace ESimSol.Reports
{
    ...
    public class rptPrintMachineList
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<CapitalResource> oCapitalResources, Company oCompany, BusinessUnit oBusinessUnit)
        {
            _oCapitalResources = oCapitalResources;
            _oCompany = oCompany;
            ...
            ESimSolPdfHelper.PrintHeader_Baly(ref _oPdfPTable, _oBusinessUnit, _oCompany, "Capital Resource List", 1);
        ...
        public void DataList()
        {
            ...
            if (_oCapitalResources.Count>0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Manufacture Name", _oFontStyleBold));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase("Supplier Name", _oFontStyleBold));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase("Cost", _oFontStyleBold));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach(CapitalResource oItem in _oCapitalResources)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.ParentName, _oFontStyle));
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.SupplierContactPerson, _oFontStyle));
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.ActualAssetValue.ToString(), _oFontStyle));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oCPdfPTable.AddCell(_oPdfPCell);

                //_oPdfPCell = new PdfPCell(new Phrase(Math.Round(oItem.ActualAssetValue, 2).ToString(), _oFontStyle));
                //_oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oCPdfPTable.AddCell(_oPdfPCell);
        ...
        public void GrandTotal()
        {
            ...
            if (_oCapitalResources.Count > 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Math.Round(_oCapitalResources.Sum(x=>x.ActualAssetValue),2).ToString(), _oFontStyleBold));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
        ...
        {
            return new float[] { 30, 90, 90, 90, 110, 90, 70 };
        }
    }
}
