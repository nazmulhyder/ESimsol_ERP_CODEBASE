...
namespace ESimSol.Reports
{
    ...
    public class rptCCOpeningBreakdowns
    {
        #region Declaration
        Document _oDocument;
        ...
        CCOpeningBreakdown _oCCOpeningBreakdown = new CCOpeningBreakdown();
        List<CCOpeningBreakdown> _oCCOpeningBreakdowns = new List<CCOpeningBreakdown>();
        Company _oCompany = new Company();
        string _sHeader = "";
        #endregion

        public byte[] PrepareReport(List<CCOpeningBreakdown> oCCOpeningBreakdowns, string sHeader, Company oCompany)
        {
            _oCCOpeningBreakdowns = oCCOpeningBreakdowns;
            _oCompany = oCompany;
            _sHeader = sHeader;
        ...
        private void PrintBody()
        {
            ...
            foreach (CCOpeningBreakdown oItem in _oCCOpeningBreakdowns)
            {
                nCount++;
            ...
            #region Total CCOpeningBreakdown Amount
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.BOLD);
