...
namespace ESimSol.Reports
{
    public class rptTAPs
    {
        ...
        public byte[] PrepareReport(TAP oTAP, string sMessage)
        {
            _oTAPs = oTAP.TAPs;
            ...
            _oDocument.Open();
            //SL No,    Order No,  Supplier   Order Date,  ApproveBy,    R.T Contact Person,  Total Amount, Status
        ...
        private void PrintBody()
        {
            ...
            foreach (TAP oItem in _oTAPs)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.PlanNo, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.PlanDateInString, _oFontStyle));
