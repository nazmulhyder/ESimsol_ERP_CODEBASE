...
{
    public class rptFabricBatchProductionBeam
    {
        #region Declaration
        ...
        public byte[] PrepareReport(List<FabricBatchProductionBeam> oFBPBs, Company oCompany, string sMessage)
        {
            _oFBPBs = oFBPBs;
            _oCompany = oCompany;
            _sMessage = sMessage;
            ...
            _oDocument.SetMargins(20f, 20f, 5f, 40f);
            ...
            _oPdfPTable.SetWidths(new float[] { 40f, 120f, 120f, 100f, 140f, 100f, 160f, 100f, 100f, 100f, 120f,90f });
            #endregion
        ...
        private void PrintBody()
        {
            if (_oFBPBs.Count > 0)
            {
                ...
                //int nSL = 0;
                //foreach (FabricBatchProductionBeam oItem in _oFBPBs)
                //{
                //    nSL++;
                ...
                //    _oPdfPCell = new PdfPCell(new Phrase(oItem.StatusRBFW, _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                //   _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oItem.QtyInMtr,2), _oFontStyle));
                ...
                //   _oPdfPCell = new PdfPCell(new Phrase(oItem.TotalEnds.ToString(), _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                //   _oPdfPCell = new PdfPCell(new Phrase(oItem.Weave, _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                //   _oPdfPCell = new PdfPCell(new Phrase(oItem.ReedCountWithDent, _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                //   _oPdfPCell = new PdfPCell(new Phrase(oItem.MachineCodeWithName, _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                //   _oPdfPCell = new PdfPCell(new Phrase(oItem.TSUName, _oFontStyle));
                //   _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                //    _oPdfPTable.CompleteRow();
                //}
                var oExeYarnDyeds = _oFBPBs.Where(x => x.IsInHouse == true && x.IsYarnDyed == true).ToList();
                if(oExeYarnDyeds.Any())
                {
                    this.PrintDataByGruoping(ref _oPdfPTable, oExeYarnDyeds, " Exe. Y/D");
                }
                var oExeSolidDyeds = _oFBPBs.Where(x => x.IsInHouse == true && x.IsYarnDyed == false).ToList();
                if (oExeSolidDyeds.Any())
                {
                    this.PrintDataByGruoping(ref _oPdfPTable, oExeSolidDyeds, " Exe. S/D");
                }

                var oScwYarnDyeds = _oFBPBs.Where(x => x.IsInHouse == false && x.IsYarnDyed == true).ToList();
                if (oExeYarnDyeds.Any())
                {
                    this.PrintDataByGruoping(ref _oPdfPTable, oScwYarnDyeds, " SCW. Y/D");
                }
                var oScwSolidDyeds = _oFBPBs.Where(x => x.IsInHouse == false && x.IsYarnDyed == false).ToList();
                if (oScwSolidDyeds.Any())
                {
                    this.PrintDataByGruoping(ref _oPdfPTable, oExeSolidDyeds, " Exe. S/D");
                }
                ...
                var nTotalQty = _oFBPBs.Sum(x => x.QtyInMtr);
                ...
                var nTotalEnds = _oFBPBs.Sum(x => x.TotalEnds);
                _oPdfPCell = new PdfPCell(new Phrase(nTotalEnds.ToString(), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        #endregion
        private  void PrintDataByGruoping(ref PdfPTable _oPdfPTable,List<FabricBatchProductionBeam> oFabricBatchProductionBeams ,string SText )
        {
            #region Table Header
            _oFontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
            _oPdfPCell = new PdfPCell(new Phrase(SText, _oFontStyle));
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Reed Count", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            var nTotalQty = oFabricBatchProductionBeams.Sum(x => x.QtyInMtr);
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nTotalQty), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            var nTotalEnds = oFabricBatchProductionBeams.Sum(x => x.TotalEnds);
            _oPdfPCell = new PdfPCell(new Phrase(nTotalEnds.ToString(), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
