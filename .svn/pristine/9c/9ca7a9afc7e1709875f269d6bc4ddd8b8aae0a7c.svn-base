...
{
    public class rptDiscontinuedEmployee
    {
        #region Declaration
        ...
        public byte[] PrepareReport(Employee oEmployee)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 25f, 100f, 70f, 65f, 55f, 60f, 50f });
            #endregion
        ...
        private void PrintBody()
        {
            ...
            foreach (Department oDepartmentItem in _oDepartments)
            {
                ...
                if (oEmployees.Count > 0)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("SEC : " + oEmployees[0].DepartmentName, _oFontStyle)); _oPdfPCell.Colspan = 7; _oPdfPCell.Border = 0;
