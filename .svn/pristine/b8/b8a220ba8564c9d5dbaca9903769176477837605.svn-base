...
namespace ESimSol.Reports
{
    ...
    public class rptPrintEmployeeProfile
    {
        #region Declaration
        Document _oDocument;
        ...
        EmployeeTINInformation _oEmployeeTINInformations = new EmployeeTINInformation();
        ...
        public byte[] PrepareReport(Employee oEmployee, Company oCompany, BusinessUnit oBusinessUnit)
        {
            _oEmployee = oEmployee;
            _oCompany = oCompany;
            _oEmployeeBankAccounts = oEmployee.EmployeeBankAccounts;
            _oEmployeeTINInformations = oEmployee.EmployeeTINInformations;
            _oBusinessUnit = oBusinessUnit;
            _oEmployeeEducations = oEmployee.EmployeeEducations;
            _oEmployeeTrainings = oEmployee.EmployeeTrainings;
            _oEmployeeSettlement = oEmployee.EmployeeSettlement;
            int ParaNumber = 1;
            int HeaderSpace = 20;
            ...
            PrintHeader();
            //PrintEmptyRow("", 20);
            this.PrintCustomPageHeader(_oEmployee.FullName + "'s Profile", 15);
            PrintEmptyRow("", 15);
            ...
            if (_oEmployee.ContactNo!=""||_oEmployee.PresentAddress!=""||_oEmployee.Email!=""||_oEmployee.ParmanentAddress!="")
            {
                PrintEmptyRow("", 20);
            ...
            if(_oEmployee.DateOfJoinInString!=""||_oEmployee.ConfirmationDateInString!="")
            {
            ...
            if (_oEmployeeTINInformations.ETIN!="")
            {
                PrintEmptyRow("", 20);
        ...
        public void PrintBankInformation(int nCount, string sHeader, int nHeaderSpace)
        {
            ...
            int nBankAccountNumber = _oEmployeeBankAccounts.Count();
            if(nBankAccountNumber == 1)
            {
                #region Data for Single Bank
                if (_oEmployeeBankAccounts[0].BankName!="")
                {
                    _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[0].BankName, _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    oPdfPTable.CompleteRow();
                }

                if (_oEmployeeBankAccounts[0].BranchName!="")
                {
                    _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[0].BranchName, _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    oPdfPTable.CompleteRow();
                }

                if (_oEmployeeBankAccounts[0].AccountNo!="")
                {
                    _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[0].AccountNo, _oFontStyleBold));
                    _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    oPdfPTable.CompleteRow();
                }
            ...
            if (nBankAccountNumber>1)
            {
                ...
                string sBankNumber = "";
                for ( int i=0; i<_oEmployeeBankAccounts.Count; i++)
                {
                    if (i==0)
                    {
                    ...
                    if (_oEmployeeBankAccounts[i].BankName!="")
                    {
                        _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[i].BankName, _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        oPdfPTable.CompleteRow();
                    }

                    if (_oEmployeeBankAccounts[i].BranchName!="")
                    {
                        _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[i].BranchName, _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        oPdfPTable.CompleteRow();
                    }

                    if (_oEmployeeBankAccounts[i].AccountNo!="")
                    {
                        _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(": " + _oEmployeeBankAccounts[i].AccountNo, _oFontStyleBold));
                        _oPdfPCell.Border = iTextSharp.text.Rectangle.NO_BORDER; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        oPdfPTable.CompleteRow();
                    }
        ...
        public void PrintCustomPageHeader(string sString, int nHeight)
        {
            PdfPTable oPdfPTable = new PdfPTable(1);
            oPdfPTable.WidthPercentage = 100;
            oPdfPTable.HorizontalAlignment = Element.ALIGN_LEFT;
