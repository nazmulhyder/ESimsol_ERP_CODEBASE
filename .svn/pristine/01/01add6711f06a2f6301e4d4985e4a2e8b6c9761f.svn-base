...
namespace ESimSol.Reports
{
    ...
    public class rptFNProductionBatch
    {
        #region Declaration
        ...
        public byte[] PrepareReport(Fabric oFabric, List<FabricSalesContractDetail> oFSCDetails, List<FNBatchCard> oFNBCards, List<FNProductionBatch> oFNPBatchs, List<FNProductionConsumption> oFNPConsumptions, Company oCompany, BusinessUnit oBU)
        {
            _oFabric = oFabric;
            ...
            //this.PrintHeader();
            ESimSolPdfHelper.PrintHeader_Baly(ref _oPdfPTable, _oBusinessUnit, _oCompany," Production Report ",0);
        ...
        public void PrintFirstTable()
        {
            ...
            oPdfPTable.SetWidths(new float[] { 50,145,60,145,50,135});
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Constraction", _oFontStyle));
            _oPdfPCell.Border = 15; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(" " + _oFabric.Construction, _oFontStyle));
            _oPdfPCell.Border = 15; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(("Total Qrder"), _oFontStyle));
            _oPdfPCell.Border = 15; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(" " + Global.MillionFormat(_oFSCDetails.Sum(x=>x.Qty)), _oFontStyle));
            _oPdfPCell.Border = 15; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            #region 3rd Row
            //_oPdfPCell = new PdfPCell(new Phrase("Section", _oFontStyle));
            ...
            //_oPdfPCell = new PdfPCell(new Phrase(": " + _oFabric.TreatmentInSt, _oFontStyle));
            //_oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            //_oPdfPCell = new PdfPCell(new Phrase("Volume", _oFontStyle));
            //_oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            //_oPdfPCell = new PdfPCell(new Phrase(": "+_oFNProductionBatch.Shade.ToString(), _oFontStyle));
            //_oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintBody()
        {
            ...
            var oProcessList = _oFNBCards.Select(x => new { 
            ...
            nColWidths[nColCount++] = 40f; //35+25 = 60
            nColWidths[nColCount++] = 35f; //60+35 = 95
            nColWidths[nColCount++] = 45f; //95+45 = 140
            nColWidths[nColCount++] = 25f; //140+25 = 165
            nColWidths[nColCount++] = 30f; //165+30 = 195

            if (oProcessList.Count()>0)
                foreach (var oItem in oProcessList)
                    nColWidths[nColCount++] = (842 - 265) / oProcessList.Count();

            nColWidths[nColCount++] = 35f;
            nColWidths[nColCount++] = 35f;
            ...
            foreach (var oFSCD in _oFSCDetails)
            {
                nCount++;
                ...
                foreach (var oItem in oProcessList)
                {
                    double nQTY = 0; // _oFNPBatchs.Where(x => x.FNBatchCardID == oItem.FNTreatmentProcessID).Sum(x => x.Q);
