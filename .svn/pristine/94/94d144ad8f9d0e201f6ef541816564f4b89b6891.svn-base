...
namespace ESimSol.BusinessObjects
{
    public class rptImportPIs
    {
        ...
        public byte[] PrepareReport(ImportPI oImportPI, string sMessage)
        {
            _oImportPIs = oImportPI.ImportPIs;
            _oCompany = oImportPI.Company;
            _sMessage = sMessage;
        ...
        private void PrintBody()
        {
            ...
            if (_oImportPIs.Count > 0)
            {
                foreach (ImportPI oItem in _oImportPIs)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.LCTermsName, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
