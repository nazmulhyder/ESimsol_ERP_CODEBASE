...
{
    public class rptMonthlyProductionRateCard
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintEmployeeProductionReceiveDetail(List<EmployeeProductionReceiveDetail> oEPReceiveDetails, string sName)
        {
            ...
            foreach (EmployeeProductionReceiveDetail oItem in oEmployeeProductionReceiveDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oItem.NewRate), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nAmount), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void BodyPartCount(List<EmployeeProductionReceiveDetail> oLists)
        {
            ...
            //sStyleNoStart = oItem.StyleNo;
            //if (bFlag)
            //{
            //    sStyleNoEnd = oItem.StyleNo;
            //    bFlag = false;
            //}
            //if(sStyleNoStart != sStyleNoEnd)
            //{   
            //    sEmployeeWiseString +="("+ CountString()+")";
            //    InitializeIntigerType();
            //}

            //if (oItem.ErrorMessage == EnumGarmentPart.Full.ToString())
            //{
            //    nFullReceive += oItem.RcvQty;

            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Front.ToString())
            //{
            //    nFrontReceive += oItem.RcvQty;

            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Back.ToString())
            //{
            //    nBackReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Sleeve_2.ToString())
            //{
            //    nFullReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.FrontPart_2.ToString())
            //{
            //    nSleeve_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.BackPart_2.ToString())
            //{
            //    nBackPart_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Neck.ToString())
            //{
            //    nNeckReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.NeckBig.ToString())
            //{
            //    nNeckBigReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.NeckSmall.ToString())
            //{
            //    nNeckSmallReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Placket_2.ToString())
            //{
            //    nPlacket_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Piping_2.ToString())
            //{
            //    nPiping_2Receive += oItem.RcvQty;
            //}

            //else if (oItem.ErrorMessage == EnumGarmentPart.Hood_2.ToString())
            //{
            //    nHood_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Hood.ToString())
            //{
            //    nHoodReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.HoodRib.ToString())
            //{
            //    nHoodRibReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Pocket.ToString())
            //{
            //    nPocketReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Pocket_2.ToString())
            //{
            //    nPocket_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.PocketRib_2.ToString())
            //{
            //    nPocketRib_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.PocketBeg_2.ToString())
            //{
            //    nPocketBeg_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.ShoulderPatch_2.ToString())
            //{
            //    nShoulderPatch_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.ElbowPatch_2.ToString())
            //{
            //    nElbowPatch_2Receive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Moon.ToString())
            //{
            //    nMoonReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.BottomRib.ToString())
            //{
            //    nBottomRibReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Armhole.ToString())
            //{
            //    nArmholeReceive += oItem.RcvQty;
            //}
            //else if (oItem.ErrorMessage == EnumGarmentPart.Fashion.ToString())
            //{
            //    nFashionReceive += oItem.RcvQty;
            //}
            //sStyleNoEnd = sStyleNoStart;
            //if (nEmployeeWiseCount == nCount)
            //{
            //    sEmployeeWiseString +="("+ CountString() +")";
            //    InitializeIntigerType();
            //}
