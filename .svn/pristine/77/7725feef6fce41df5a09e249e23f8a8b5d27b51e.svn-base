...
namespace ESimSol.Reports
{
    ...
    public class rptProductionOrderList
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(ProductionOrder oProductionOrder)
        {
            _oProductionOrders = oProductionOrder.ProductionOrderList;
            ...
            _oPdfPTable.SetWidths(new float[] { 7f, 15f, 15f, 18f, 18f, 12f, 17f, 16f, 15f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.FixedHeight = 30f; _oPdfPCell.Colspan = 9; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            #endregion
