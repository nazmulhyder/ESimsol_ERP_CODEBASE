...
namespace ESimSol.Reports
{
    ...
    public class rptLCTransferList
    {
        #region Declaration
        Document _oDocument;
        ...
        {
            _oLCTransfers = oLCTransfer.LCTransfers;
            _oCompany = oCompany;
            ...
            _oPdfPTable.SetWidths(new float[] { 20f, // SL No
                                                ...
                                                35f, //Transfer Date
                                                40f, // Buyer
                                                60f, //Production Factory
                                                85f, // Bank Account
                                                50f, // Is Commisson Collect
                                                40f, // LC Ammount
                                                50f, // Transfer Ammount 
                                                35f // Commission Amount
                                                 });
            this.PrintHeader();
            this.PrintBody();
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("LC Transfer List", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Commission Collect", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("LC Amount", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (LCTransfer oItem in _oLCTransfers)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.BankNameAccountNo, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                if (oItem.IsCommissionCollect == true)
                {
                ...
                {
                    _oPdfPCell = new PdfPCell(new Phrase("No", _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                }
