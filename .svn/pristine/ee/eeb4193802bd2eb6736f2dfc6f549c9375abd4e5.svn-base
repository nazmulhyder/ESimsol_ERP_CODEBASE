...
{
    public class rptDisciplinaryAction
    {
        #region Declaration
        ...
        DisciplinaryAction _oDisciplinaryAction = new DisciplinaryAction();
        List<DisciplinaryAction> _oDisciplinaryActions = new List<DisciplinaryAction>();
        ...
        public byte[] PrepareReport(DisciplinaryAction oDisciplinaryAction)
        {
            _oDisciplinaryActions = oDisciplinaryAction.DisciplinaryActions;
            _oCompany = oDisciplinaryAction.Company;

            //DateTime dDateFrom = Convert.ToDateTime(oDisciplinaryAction.ErrorMessage.Split('~')[0]);
            //DateTime dDateTo = Convert.ToDateTime(oDisciplinaryAction.ErrorMessage.Split('~')[1]);
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 15f, 80f, 80f, 65f, 40f, 40f,45f, 50f});
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Advance Payment List", _oFontStyle));
            _oPdfPCell.Colspan = 8;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("P. AMOUNT", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL);
            foreach (DisciplinaryAction oDisciplinaryActionItem in _oDisciplinaryActions)
            {
                nCount++;
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oDisciplinaryActionItem.EmployeeCode, _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oDisciplinaryActionItem.EmployeeName, _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oDisciplinaryActionItem.DesignationName, _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(Convert.ToDouble(oDisciplinaryActionItem.Remark)), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oDisciplinaryActionItem.Amount), _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oDisciplinaryActionItem.JoiningDateInString, _oFontStyle)); _oPdfPCell.FixedHeight = 20;
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
