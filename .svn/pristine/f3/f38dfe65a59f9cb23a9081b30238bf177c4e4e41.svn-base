...
{
    public class rptFNRequisitionList
    {
        #region Declaration
        int _nTotalColumn = 1;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<FNRequisition> oFNRequisitions, Company oCompany)
        {
        ...
        {
            this.PrintHeaderDetail("Chemical Requisition List", " ", " ");
            this.SetData();
        }
        #endregion
        ...
        private void SetData()
        {
            ...
            oPdfPTable.SetWidths(new float[] { 5f, 8f, 12f, 7f, 14f, 10f, 11f, 8f, 14f, 14f, 14f, 7f });
            ...
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Section", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ...
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Issue Date", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Type", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Approve By", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Disburse By", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Receive By", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ...
            #region data
            foreach (var oItem in _oFNRequisitions)
            {
                oPdfPTable = new PdfPTable(12);
                oPdfPTable.SetWidths(new float[] { 5f, 8f, 12f, 7f, 14f, 10f, 11f, 8f, 14f, 14f, 14f, 7f });
                ...
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.TreatmentInSt, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.ShiftInSt, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.FNExONo, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ...
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.IsRequisitionOpenSt, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.ApproveByName, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.DisburseByName, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.ReceiveByName, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oItem.ShadeInString, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
