...
namespace ESimSol.Reports
{
    public class rptLCTerm
    {
        ...
        public byte[] PrepareReport(List<LCTerm> oLCTerms, Company oCompany, string sMessage)
        {
            _oLCTerms = oLCTerms;
            _oCompany = oCompany;
            _sMessage = sMessage;
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 30f, 200f, 200f });
            #endregion
        ...
        private void PrintBody()
        {
            if (_oLCTerms.Count > 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase("LC Terms", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                int nCount = 0;
                foreach (LCTerm oItem in _oLCTerms)
                {
                    nCount++;
            ...
            else 
            {
                ...
                _oPdfPCell.Colspan = _nTotalColumn; _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                _oPdfPTable.CompleteRow();
