...
{
    public class rptExportPIReport_MKTPersonWise
    {
        #region Declaration
        ...
        public byte[] PrepareReport(List<ExportPIReport> oExportPIReports, Company oCompany, string sDateRange)
        {
            _oExportPIReports = oExportPIReports.OrderBy(x => x.MKTPName).ToList();
            _oCompany = oCompany;
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 13f, 30f, 53f, 50f, 50f, 50f, 50f, 40f, 40f, 50f, 50f, 50f });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            oPdfPTableHeader.SetWidths(new float[] { 200f, 255f });
            ...
            _oPdfPCell = new PdfPCell(new Phrase(" PI List(MKT. Person Wise)", _oFontStyle));
            _oPdfPCell.Colspan = 12;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintHeadRow(ExportPIReport oPIR)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("MKT. Person : " + oPIR.MKTPName, _oFontStyle)); _oPdfPCell.Colspan = 12; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintBody()
        {
            ...
            string MUnit = _oExportPIReports[0].MUName;
            string CSymbol = _oExportPIReports[0].Currency;
            while (_oExportPIReports.Count > 0)
            {
                List<ExportPIReport> oTempPIRs = new List<ExportPIReport>();
                oTempPIRs = _oExportPIReports.Where(x => x.MKTPName == _oExportPIReports[0].MKTPName).ToList();
                PrintProductWisePCReport(oTempPIRs);
                _oExportPIReports.RemoveAll(x => x.MKTPName == oTempPIRs[0].MKTPName);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nTotalQty.ToString() + MUnit, _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(CSymbol + Global.MillionFormat(nTotalAmount), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void PrintProductWisePCReport(List<ExportPIReport> oExportPIReports)
        {
            int nCount = 0;
            ...
            PrintHeadRow(oExportPIReports[0]);
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL);
            foreach (ExportPIReport oPIReportItem in oExportPIReports)
            {
                nCount++;
