...
{
    public class rptSalarySheet_OT_MAMIYA
    {
        #region Declaration
        ...
        string _sStartDate = "";
        string _sEndDate = "";
        bool _bViewESS = false;
        int _nColSpan = 0;
        #endregion

        public byte[] PrepareReport(EmployeeSalary oEmployeeSalary, bool bViewESS)
        {
            _oEmployeeSalarys = oEmployeeSalary.EmployeeSalarys.Where(x => x.IsAllowOverTime == true && x.OTHour >0).ToList();
            ...
            if (_bViewESS) { _oPdfPTable = new PdfPTable(6); }
            else { _oPdfPTable = new PdfPTable(5); }
            #region Page Setup
            ...
            if (_bViewESS)
            {
                _oPdfPTable.SetWidths(new float[] { 20f, 250f, 120f, 50f,  50f, 70f });
                _nColSpan = 6;
            }
            else { _oPdfPTable.SetWidths(new float[] { 20f, 250f, 50f, 50f, 70f }); _nColSpan = 5; }
            #endregion
        ...
        public void DepartmentWiseTotal()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 40; _oPdfPCell.Colspan = _nColSpan; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void Footer()
        {
            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 20; _oPdfPCell.Colspan = _nColSpan; _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
