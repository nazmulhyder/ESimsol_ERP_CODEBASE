...
namespace ESimSol.Reports
{
    ...
    public class rptOrderRecapList
    {
        #region Declaration
        Document _oDocument;
        ...
        double _nSumOrderRecapAmount = 0; double _nTotalQty = 0; bool bIsDifferentUnitExist = false, bIsDeffrentCurrencyExist = false;
        int nPriovoiusUnitID, nPriviousCurrencyID;
        #endregion

        #region Order Recap List
        ...
        private void PrintHeader()
        {
            ...
            #region ReportHeader
            _oPdfPCell = new PdfPCell(new Phrase("Order Recap List", _oFontStyle));
            _oPdfPCell.Colspan = 14;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Ship. Dt", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
           ...
           int nCount = 0; nPriovoiusUnitID = _oOrderRecaps[0].MeasurementUnitID; nPriviousCurrencyID = _oOrderRecaps[0].CurrencyID;
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, 0);
            foreach (OrderRecap oItem in _oOrderRecaps)
            {
                nCount++;
                if(nPriviousCurrencyID !=oItem.CurrencyID)
                {
                    bIsDeffrentCurrencyExist = true;
                }
                if(nPriovoiusUnitID!=oItem.MeasurementUnitID)
                {
                    bIsDifferentUnitExist = true;
                }
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.TotalQuantity.ToString(), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.CurrencySymbol + " " +oItem.UnitPriceInString.ToString(), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPTable.CompleteRow();
                _nSumOrderRecapAmount = _nSumOrderRecapAmount + oItem.Amount;
                _nTotalQty += oItem.TotalQuantity;
            }
            //if(bIsDifferentUnitExist==false || bIsDeffrentCurrencyExist==false)
            //{
                #region Total OrderRecap Amount
            ...
            //    _oPdfPCell = new PdfPCell(new Phrase((bIsDifferentUnitExist==false)?_nTotalQty.ToString():"", _oFontStyle));
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatRound(_nTotalQty,0), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                //_oPdfPCell = new PdfPCell(new Phrase((bIsDeffrentCurrencyExist==false)? Global.MillionFormat(_nSumOrderRecapAmount):"", _oFontStyle));
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nSumOrderRecapAmount), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
