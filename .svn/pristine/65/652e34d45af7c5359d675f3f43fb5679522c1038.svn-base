...
namespace ESimSol.Reports
{
    public class rptCashSheetV2
    {
        ...
        bool _bHasOTAllowance = false,_IsOT=false;

        #endregion
        public byte[] PrepareReport(List<EmployeeSalaryV2> oEmployeeSalarys,Company oCompany,bool isOT)
        {
            _oEmployeeSalarys = oEmployeeSalarys;
            _oCompany = oCompany;
            _IsOT = isOT;
        ...
        private void PrintHeader()
        {
            ...
            {
                oPdfPCellHearder = new PdfPCell(new Phrase("", _oFontStyle)); oPdfPCellHearder.Border = 0; oPdfPCellHearder.Colspan = 2; oPdfPCellHearder.FixedHeight = 15;
            ...
            oPdfPCellHearder = new PdfPCell(new Phrase("Cash Sheet", _oFontStyle));
            oPdfPCellHearder.Colspan = 2;
            oPdfPCellHearder.HorizontalAlignment = Element.ALIGN_CENTER;
            oPdfPCellHearder.Border = 0;
            oPdfPCellHearder.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            foreach (EmployeeSalaryV2 oItem in _oEmployeeSalarys)
            {
                if (oItem.CashAmount > 0)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.CashAmount.ToString("###,##0;(###,##0)"), _oFontStyle));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(nTotalAmount.ToString("###,##0;(###,##0)"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            ...
            _oPdfPCell = new PdfPCell(new Phrase("In Words : " + Global.TakaWords(Math.Round(nTotalAmount, 0)), _oFontStyle)); _oPdfPCell.Colspan = 7;
            _oPdfPCell.Border = 0;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
