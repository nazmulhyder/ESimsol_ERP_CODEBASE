...
namespace ESimSol.Reports
{
    ...
    public class rptGLMonthlySummarys
    {
        #region Declaration
        Document _oDocument;
        ...
        GLMonthlySummary _oGLMonthlySummary = new GLMonthlySummary();
        List<GLMonthlySummary> _oGLMonthlySummarys = new List<GLMonthlySummary>();
        Company _oCompany = new Company();
        string _sHeader = "";
        #endregion

        public byte[] PrepareReport(List<GLMonthlySummary> oGLMonthlySummarys, string sHeader, Company oCompany)
        {
            _oGLMonthlySummarys = oGLMonthlySummarys;
            _oCompany = oCompany;
            _sHeader = sHeader;
            ...
            _oPdfPTable.SetWidths(new float[] { 30f, 265f, 80f, 80f, 80f });//535
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPCell.Rowspan = 2; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Month", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPCell.Rowspan = 2; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Opening Balance", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPCell.Colspan = 2; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Closing Balnce", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPCell.Rowspan = 2; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (GLMonthlySummary oItem in _oGLMonthlySummarys)
            {
                nCount++;
                _oPdfPCell = new PdfPCell(new Phrase(nCount.ToString(), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.NameOfMonth, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            #region Total GLMonthlySummary Amount
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.BOLD);
