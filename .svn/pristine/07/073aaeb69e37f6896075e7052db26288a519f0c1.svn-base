...
{
    public class rptReceivedCheques
    {
        #region Declaration
        Document _oDocument;
        ...
        double _nSumReceivedChequeAmount = 0;
        string _sMessage = "";

        #endregion

        public byte[] PrepareReport(List<ReceivedCheque> oReceivedCheques, Company oCompany, string sMessage)
        {
            _oReceivedCheques = oReceivedCheques;
            _oCompany = oCompany;
            _sMessage = sMessage;
            ...
            _oDocument.Open();
            //SL No,    ReceivedCheque No, ReceivedCheque Name,   Narration,  Date,   Authorized By,  Amount,Con. Rate,   Amount
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("ReceivedCheque Name", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (ReceivedCheque oItem in _oReceivedCheques)
            {
                nCount++;
