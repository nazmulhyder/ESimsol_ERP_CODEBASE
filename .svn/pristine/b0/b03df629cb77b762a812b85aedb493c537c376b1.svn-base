...
{
    public class rptSalesCommissionPaymentreport
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(SalesComPayment oSalesComPayment, List<SalesComPaymentDetail> oSalesComPaymentDetails, List<ExportPIReport> oExportPIReports, List<ExportBill> oExportBills, List<SalesCommissionPayable> oSalesCommissionPayables, List<SalesComPayment> oSalesComPaymentsByPayables, Company oCompany, BusinessUnit oBusinessUnit)
        {
            ...
            _oSalesComPayments = oSalesComPaymentsByPayables;
            _oCompany = oCompany;
            ...
            #endregion
            this.PrintHeader();
            if (_oSalesComPayment != null)
            {
                this.Print_CommissionMemoHeader();
                this.Print_SalesCompayment();
                //if (_oSalesComPaymentDetails.Any())
                //{
                //    this.Print_SalesComPaymentDetails();
                //}
                if (_oExportPIReports.Any())
                {
                    ...
                    {
                        _sMunitTwo = "Dzn";
                        this.Print_ExportPIReportHanger(1);
                    }
                    else
                    {
                        this.Print_ExportPIReports(1);
                    }
                }
                if (_oExportBills.Any())
                {
                    this.Print_BillDetails();
                    if (oSalesCommissionPayables.Any())
                    {
        ...
        private void Print_CommissionMemoHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Commission Memo(Payment)", _oFontStyle));
        ...
        #region Payment
        private void Print_SalesCompayment()
        {
            PdfPTable oPdfPTable = new PdfPTable(8);
            PdfPCell oPdfPCell;
            oPdfPTable.SetWidths(new float[] { 90f, 60f, 50f, 100f, 50f, 100f, 60f, 60f });
            ...
            oPdfPCell = new PdfPCell(new Phrase(":  " + _oSalesComPayment.MRNo, _oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            oPdfPCell = new PdfPCell(new Phrase("MR. Date:  " + _oSalesComPayment.MRDateStr, oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Colspan = 2;
            ...
            oPdfPCell = new PdfPCell(new Phrase("Person Name :", _oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            oPdfPCell = new PdfPCell(new Phrase(":  " + _oSalesComPayment.CPName, _oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            oPdfPCell.Colspan = 4;
            oPdfPTable.AddCell(oPdfPCell);
            if (_oExportPIReports != null && _oExportPIReports.Count > 0)
            {
                _oSalesComPayment.ErrorMessage = string.Join(" ,", _oExportPIReports.Select(x => x.BuyerName).Distinct());
            }
            oPdfPCell = new PdfPCell(new Phrase("Buying House :" + _oSalesComPayment.ErrorMessage, oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            oPdfPCell = new PdfPCell(new Phrase("Factory Name", oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            if (_oExportPIReports != null && _oExportPIReports.Count > 0)
            {
                _oSalesComPayment.ContractorName = string.Join(" ,", _oExportPIReports.Select(x => x.ContractorName).Distinct());
            }
            oPdfPCell = new PdfPCell(new Phrase(":  " + _oSalesComPayment.ContractorName, oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            oPdfPCell = new PdfPCell(new Phrase("Value  ", oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            oPdfPTable.AddCell(oPdfPCell);
            oPdfPCell = new PdfPCell(new Phrase(":  " +((_oExportBills.Count>0)? _oExportBills[0].Currency:"") + " " + Global.MillionFormat(_oSalesComPayment.Amount).ToString(), oFontStyle));
            oPdfPCell.Colspan = 7;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            oPdfPCell = new PdfPCell(new Phrase("Document Description  ", oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            oPdfPCell = new PdfPCell(new Phrase(":  " + _oSalesComPayment.PaymentTypeStr, oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPCell.Border = 0;
            ...
            if (_oSalesComPayment.PaymentType == EnumPayment_CommissionType.Document)
            {
                oPdfPCell = new PdfPCell(new Phrase("Doc No", oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase( _oSalesComPayment.DocNo, oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase("Bank Name", oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase( _oSalesComPayment.BankNameWithBranch, oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase("ACC. Name ", oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase( _oSalesComPayment.AccountName, oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase("Acc. No", oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                oPdfPCell = new PdfPCell(new Phrase(_oSalesComPayment.AccountNo, oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void Print_BillDetails()
        {
            ...
            PdfPCell oPdfPCell;
            oPdfPTable.SetWidths(new float[] { 12f, 65f, 75f, 80f, 50f, 30f, 55f, 55f, 30f, 55f });
            int RowHeight = 18;
            int nCount = 0;
            ...
            if (_oExportBills.Any())
            {
                ...
                foreach (ExportBill oItem in _oExportBills)
                {
                    ...
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell.BackgroundColor = BaseColor.WHITE;
                    oPdfPTable.AddCell(oPdfPCell);
                    oPdfPCell = new PdfPCell(new Phrase(oItem.ExportLCNo, _oFontStyle));
                    oPdfPCell.FixedHeight = RowHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.BackgroundColor = BaseColor.WHITE;
                    oPdfPTable.AddCell(oPdfPCell);
                    ...
                    oPdfPCell = new PdfPCell(new Phrase(oItem.Currency + " " + oItem.Amount, _oFontStyle));
                    oPdfPCell.FixedHeight = RowHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell.BackgroundColor = BaseColor.WHITE;
                    oPdfPTable.AddCell(oPdfPCell);
        ...
        private void PrintBody(List<SalesCommissionPayable> oSalesCommissionPayables)
        {
            ...
            foreach (SalesCommissionPayable oItem in oSalesCommissionPayables)
            {
                ...
                oPdfPCell = new PdfPCell(new Phrase(Currency + Global.MillionFormat(oItem.MaturityAmount + oItem.RealizeAmount - oItem.AdjDeduct - oItem.AdjPayable), _oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell.BackgroundColor = BaseColor.WHITE;
                oPdfPTable.AddCell(oPdfPCell);
                ...
                oPdfPCell = new PdfPCell(new Phrase(Currency + Global.MillionFormat(oItem.MaturityAmount + oItem.RealizeAmount - oItem.AdjDeduct - oItem.AdjPayable - oItem.Amount_Paid), _oFontStyle));
                oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
        ...
        private void Print_SalesCommissionPayment()
        {
            ...
            if (oApprovedPayments.Any())
            {
                ...
                foreach (SalesComPayment oItem in oApprovedPayments)
                {
                    ...
                    oPdfPCell = new PdfPCell(new Phrase(((_oExportBills.Count>0)? _oExportBills[0].Currency:"") + " " + Global.MillionFormat(oItem.Amount).ToString(), _oFontStyle));
            ...
            oPdfPCell = new PdfPCell(new Phrase(((_oExportBills.Count > 0) ? _oExportBills[0].Currency : "") + " " + Global.MillionFormat(nTotalComPayment).ToString(), _oFontStyle));
            oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            oPdfPCell.BackgroundColor = BaseColor.WHITE;
            oPdfPTable.AddCell(oPdfPCell);
