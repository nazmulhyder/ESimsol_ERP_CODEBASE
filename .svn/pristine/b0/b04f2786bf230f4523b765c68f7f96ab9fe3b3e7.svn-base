...
namespace ESimSol.Reports
{
    ...
    public class rptExportDocBeneficiaryCertificate
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("THIS IS TO CERTIFY THAT THE GOODS ARE SUPPLIED PROPERLY AS PER P.I. NO: " + _oExportCommercialDoc.PINos + " AGAINST BTB L/C NO. "+_oExportCommercialDoc.ExportLCNo+" EXPORT S/C NO-", _oFontStyleBold));
