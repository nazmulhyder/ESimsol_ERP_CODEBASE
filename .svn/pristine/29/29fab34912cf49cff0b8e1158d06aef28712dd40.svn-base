...
{
    public class rptMonthWiseExportPIList 
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintHeader(string ReportNo)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Month Wise Proforma Invoice List", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Colspan = 9;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            if (_oProformaInvoices.Count > 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oProformaInvoices[0].IssueDate.ToString("MMM yy")+" :", _oFontStyle));
                ...
                nTempMonth = _oProformaInvoices[0].IssueDate.Month;
                nTempYear = _oProformaInvoices[0].IssueDate.Year;
                _oPdfPTable.CompleteRow();
                DetailCaptionPrint();
                #endregion
                ...
                foreach (ProformaInvoice oItem in _oProformaInvoices)
                {
                    ...
                    if (nTempMonth != oItem.IssueDate.Month)
                    {
                        #region Total print
                        _oFontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase("$ " + Global.MillionFormat(_nMonthWiseTotal), _oFontStyle));
                        ...
                        #region New Date Print

                        _oFontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
                        _oPdfPCell = new PdfPCell(new Phrase(oItem.IssueDate.ToString("MMM yy")+" :", _oFontStyle));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.Colspan = 9; _oPdfPCell.Border = 0; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                        _oPdfPTable.CompleteRow();
                        DetailCaptionPrint();
                        nTempMonth = oItem.IssueDate.Month;
                        nTempYear = oItem.IssueDate.Year;
                        nCount = 0;
                        #endregion

                    }
                    else if (nTempYear != oItem.IssueDate.Year)
                    {
                        #region Total print
                        _oFontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
                        _oPdfPCell = new PdfPCell(new Phrase("Total :", _oFontStyle));
                    ...
                    _nMonthWiseTotal += oItem.NetAmount;
