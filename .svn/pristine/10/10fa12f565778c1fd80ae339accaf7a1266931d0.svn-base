...
namespace ESimSol.Reports
{
    ...
    public class rptVehicleOrder
    {
        ...
        List<VehicleOrderDetail> _oVehicleOrderDetails = new List<VehicleOrderDetail>();
        VehicleOrderImage _oVehicleOrderImage = new VehicleOrderImage();
        Company _oCompany = new Company();

        #endregion

        public byte[] PrepareReport(VehicleOrder oVehicleOrder, Company oCompany)
        {
            _oVehicleOrder = oVehicleOrder;
            _oVehicleOrderDetails = oVehicleOrder.VehicleOrderDetails;
            _oVehicleOrderImage = oVehicleOrder.VehicleOrderImage;
            _oCompany =oCompany;
        ...
        private void PrintHeader()
        {
            ...
            #region ReportHeader
            _oFontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
            _oPdfPCell = new PdfPCell(new Phrase("Vehicle Order", _oFontStyle));
        ...
        {
            #region Vehicle ORdr Information
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.RefNo, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.IssueDateInString, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.ModelNo, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.ChassisNo, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.EngineNo, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.ExteriorColorName, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.InteriorColorName, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.ETAValueWithTypeInString, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.FeatureSetupName, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            #region 10th Row
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oVehicleOrder.Remarks, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
            ...
            #region Vehicle Order Detail Information
            oPdfPTable = new PdfPTable(5);
            oPdfPTable.WidthPercentage = 100;
            oPdfPTable.HorizontalAlignment = Element.ALIGN_LEFT;
            oPdfPTable.DefaultCell.Border = iTextSharp.text.Rectangle.NO_BORDER;
            oPdfPTable.SetWidths(new float[] { 30f, 100f, 200f, 80f, 100f});
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Vehicle Order Detail", _oFontStyle));
            _oPdfPCell.Colspan = 4;
           ...
           _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (VehicleOrderDetail oItem in _oVehicleOrderDetails)
            {
