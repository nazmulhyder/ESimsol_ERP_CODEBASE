...
{
    public class SalarySummery_F2DA
    {
        public SalarySummery_F2DA() { }
        ...
        {
            return tc.ExecuteReader("EXEC [SP_Rpt_SalarySummary_F2] %s,%s,%s,%s,%s,%s,%n,%n,%n,%b,%n,%s,%s,%n,%n",
        ...
        public static IDataReader GetsSalarySummaryComp(string BusinessUnitIDs, string LocationIDs, string DepartmentIDs, string DesignationIDs, string SalarySchemeIDs, string EmployeeIDs, int PayType, int MonthID, int Year, bool NewJoin, bool bIsOutSheet, string sGroupIDs, string sBlockIDs, Int64 nUserID, TransactionContext tc)
        {
            return tc.ExecuteReader("EXEC [SP_Rpt_Comp_SalarySummary] %s,%s,%s,%s,%s,%s,%n,%n,%n,%b, %b,%n,%s,%s",
        ...
        public static IDataReader GetsGroup(string BusinessUnitIDs, string LocationIDs, string DepartmentIDs, string DesignationIDs, string SalarySchemeIDs, string EmployeeIDs, int PayType, int MonthID, int Year, bool NewJoin, int EmpGrouping, double nStartSalaryRange, double nEndSalaryRange, Int64 nUserID, TransactionContext tc)
        {
            return tc.ExecuteReader("EXEC [SP_Rpt_SalarySummary_BUWise_Group] %s,%s,%s,%s,%s,%s,%n,%n,%n,%b,%n,%n,%n,%n",
