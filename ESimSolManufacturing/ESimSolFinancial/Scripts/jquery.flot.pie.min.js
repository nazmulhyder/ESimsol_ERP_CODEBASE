                ...
                function drawLabels() {
                    ...
                    function drawLabel(slice, startAngle, index) {
                        if (slice.data[0][1] == 0)
                            ...
                            redraw = true; if (options.series.pie.label.background.opacity != 0) {
