...
{
    public class rptRecapOrderSheetPreviewDefaultFormat
    {
        ...
        public byte[] PrepareReportDefaultFormat(OrderRecap oOrderRecap, BusinessUnit oBusinessUnit)
        {
        ...
        private void PrintBody()
        {
            ...
            _oFontStyle = FontFactory.GetFont("Tahoma", 8.5f, iTextSharp.text.Font.NORMAL);
            _oPdfPCell = new PdfPCell(new Phrase("Merchandiser                                                                               Merchandiser Manager                                                                           Q.C Manager                                                                             Managing Director", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _oPdfPCell.VerticalAlignment = Element.ALIGN_BOTTOM;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private PdfPTable GetAccessoriesTable()
        {
            ...
            #region caption
            _oPdfPCell = new PdfPCell(new Phrase("Material Description", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
