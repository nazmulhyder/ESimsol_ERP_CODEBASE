...
namespace ESimSol.Reports
{
    ...
    public class rptTransferRequisitionSlipRegisters
    {
        #region Declaration
        PdfWriter _oWriter;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<TransferRequisitionSlipRegister> oTransferRequisitionSlipRegisters, Company oCompany, EnumReportLayout eReportLayout, string sDateRange)
        {
            _oTransferRequisitionSlipRegisters = oTransferRequisitionSlipRegisters;
            _oCompany = oCompany;
            ...
            {
                this.PrintHeader("Issue Store wise Transfer Register(Details)", sDateRange);
                this.PrintIssueStoreWiseDetails();
                _oPdfPTable.HeaderRows = 3;
            }
            else if (eReportLayout == EnumReportLayout.Receive_Store_Wise)
            {
                this.PrintHeader("Receive Store Wise TransferRegister(Details)", sDateRange);
                this.PrintReceiveStoreWiseDetails();
                _oPdfPTable.HeaderRows = 3;
            }
            else if (eReportLayout == EnumReportLayout.DateWiseDetails)
            {
                this.PrintHeader("Date Wise Transfer Register(Details)", sDateRange);
                this.PrintBodyDateWiseDetails();
                _oPdfPTable.HeaderRows = 3;
            }
            else if (eReportLayout == EnumReportLayout.ProductWise)
            {
                this.PrintHeader("Product Wise Transfer Register", sDateRange);
        ...
        #region Report Body
        private void PrintIssueStoreWiseDetails()
        {
            ...
            int nTRSID = 0; string sIssueStoreName = ""; int nCount = 0; int nRowSpan = 0;
            double nTotalQty = 0, nIssueStoreWiseQty = 0, nGrandTotalQty = 0;
            foreach (TransferRequisitionSlipRegister oItem in _oTransferRequisitionSlipRegisters)
            {
                if (sIssueStoreName != oItem.IssueStoreName)
                {
                    if (oPdfPTable.Rows.Count > 0)
                    {
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase("Store Wise Total :", _oFontStyleBold));
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nIssueStoreWiseQty), _oFontStyleBold));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        nTotalQty = 0; nIssueStoreWiseQty = 0;
                    }
                    ...
                    #region Date Heading
                    _oPdfPCell = new PdfPCell(new Phrase("Store Name : " + oItem.IssueStoreName, _oFontStyleBoldUnderLine));
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("Receive Store", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
                ...
                if (nTRSID != oItem.TRSID)
                {
                    ...
                    nCount++;
                    nRowSpan = _oTransferRequisitionSlipRegisters.Where(ChallanR => ChallanR.TRSID == oItem.TRSID).ToList().Count + 1;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.TransferStatusSt, _oFontStyle));
                    _oPdfPCell.Rowspan = nRowSpan; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintReceiveStoreWiseDetails()
        {
            _oFontStyle = FontFactory.GetFont("Tahoma", 7.5f, iTextSharp.text.Font.NORMAL);
            _oFontStyleBold = FontFactory.GetFont("Tahoma", 7.5f, iTextSharp.text.Font.BOLD);
            _oFontStyleBoldUnderLine = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.BOLD | iTextSharp.text.Font.UNDERLINE);
            ...
            int nTRSID = 0; string sReceiveStoreName = ""; int nCount = 0; int nRowSpan = 0;
            double nTotalQty = 0, nReceiveStoreWiseQty = 0, nGrandTotalQty = 0;
            foreach (TransferRequisitionSlipRegister oItem in _oTransferRequisitionSlipRegisters)
            {
                if (sReceiveStoreName != oItem.ReceivedStoreName)
                {
                    if (oPdfPTable.Rows.Count > 0)
                    {
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormatActualDigit(nReceiveStoreWiseQty), _oFontStyleBold));
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                        ...
                        nTotalQty = 0; nReceiveStoreWiseQty = 0;
                    }
                    ...
                    #region Date Heading
                    _oPdfPCell = new PdfPCell(new Phrase("Store Name : " + oItem.ReceivedStoreName, _oFontStyleBoldUnderLine));
                    _oPdfPCell.Colspan = 11; _oPdfPCell.FixedHeight = 14f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    oPdfPTable.CompleteRow();
                    #endregion
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("Issue Store", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintBodyDateWiseDetails()
        {
            ...
            int nTRSID = 0; DateTime dIssueDateTime = DateTime.MinValue; int nCount = 0; int nRowSpan = 0;
            ...
            foreach (TransferRequisitionSlipRegister oItem in _oTransferRequisitionSlipRegisters)
            {
                if (dIssueDateTime.ToString("dd MMM yyyy") != oItem.IssueDateTime.ToString("dd MMM yyyy"))
                {
                    ...
                    #region Date Heading
                    _oPdfPCell = new PdfPCell(new Phrase("Challan Date @ " + oItem.IssueDateTimeSt, _oFontStyleBoldUnderLine));
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("Approve By", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
