...
namespace ESimSol.Reports
{
    ...
    public class rptAccountWiseCCBreakdowns
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<CostCenterBreakdown> oCostCenterBreakdowns, string sHeader, Company oCompany)
        {
            ...
            _oPdfPTable.SetWidths(new float[] { 30f, 45f, 140f, 80f, 80f, 80f, 80f });//535
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Opening Balnce", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
