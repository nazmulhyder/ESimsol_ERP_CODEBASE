...
{
    public class rptTimeCard_F04V2
    {
        #region Declaration
        ...
        public PdfPTable GetTimeCard(List<AttendanceDailyV2> oAttendanceDailyV2s)
        {
            ...
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL);
            oPdfPCell = new PdfPCell(new Phrase(": " + oAttendanceDailyV2s[0].EmployeeCode, _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.FixedHeight = _nFixedHeight; oPdfPCell.Colspan = 3;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            ...
            oPdfPCell = new PdfPCell(new Phrase(": " + oAttendanceDailyV2s[0].EmployeeName, _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3; oPdfPCell.FixedHeight = _nFixedHeight; oPdfPCell.Colspan = 3;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            oPdfPCell = new PdfPCell(new Phrase(": " + oAttendanceDailyV2s[0].DepartmentName, _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            ...
            oPdfPCell = new PdfPCell(new Phrase(": " + oAttendanceDailyV2s[0].DesignationName, _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3; oPdfPCell.FixedHeight = _nFixedHeight;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL); oPdfPCell.FixedHeight = _nFixedHeight;
            oPdfPCell = new PdfPCell(new Phrase(": " + oAttendanceDailyV2s[0].JoiningDateInString, _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            ...
            while (dstartDate.ToString("dd MMM yyyy") != dEndDate.ToString("dd MMM yyyy"))
            {
                ...
                if (oTempAttendanceDailyV2 != null)
                {
                    ...
                    oPdfPCell = new PdfPCell(new Phrase(Global.MinInHourMin(oTempAttendanceDailyV2.LateArrivalMinute), _oFontStyle)); oPdfPCell.FixedHeight = _nFixedHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);

                    oPdfPCell = new PdfPCell(new Phrase(oTempAttendanceDailyV2.OutTimeInString, _oFontStyle)); oPdfPCell.FixedHeight = _nFixedHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);

                    oPdfPCell = new PdfPCell(new Phrase(Global.MinInHourMin(oTempAttendanceDailyV2.EarlyDepartureMinute), _oFontStyle)); oPdfPCell.FixedHeight = _nFixedHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
                    ...
                    oPdfPCell = new PdfPCell(new Phrase("(" + oTempAttendanceDailyV2.ShiftStartTime.ToString("HH:mm") +"-"+ oTempAttendanceDailyV2.ShiftEndTime.ToString("HH:mm")+")", _oFontStyle)); oPdfPCell.FixedHeight = _nFixedHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);


                    oPdfPCell = new PdfPCell(new Phrase(Global.MinInHourMin(oTempAttendanceDailyV2.ShiftDuration), _oFontStyle)); oPdfPCell.FixedHeight = _nFixedHeight;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
            ...
            oPdfPCell = new PdfPCell(new Phrase("Total Working Hr: " + AttendanceDailyV2.GetAttendanceSummary(oAttendanceDailyV2s, "Total Working Hour"), _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3; oPdfPCell.FixedHeight = _nFixedHeight;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);

            oPdfPCell = new PdfPCell(new Phrase("Total Shift Duration: " + AttendanceDailyV2.GetAttendanceSummary(oAttendanceDailyV2s, "SD"), _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 3; oPdfPCell.FixedHeight = _nFixedHeight;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
        ...
        public PdfPTable GetFooterTable(List<AttendanceDailyV2> oAttendanceDailyV2s)
        {
            ...
            int nTSDuration = Convert.ToInt32(AttendanceDailyV2.GetAttendanceSummary(oAttendanceDailyV2s, "SD", false));
            int nTWorkingHour = Convert.ToInt32(AttendanceDailyV2.GetAttendanceSummary(oAttendanceDailyV2s, "Total Working Hour", false));
            ...
            _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL);
            oPdfPCell = new PdfPCell(new Phrase(": "+Global.MinInHourMin(nOvLessValue), _oFontStyle)); oPdfPCell.Border = 0; oPdfPCell.Colspan = 2;
            oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(oPdfPCell);
