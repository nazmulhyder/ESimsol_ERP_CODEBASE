...
{
    public class rptSampleRequest1
    {
        #region Declaration
        //int _nTotalColumn = 8;
        ...
        private void PrintHeader()
        {
            ...
            #endregion
            _oPdfPCell = new PdfPCell(new Phrase("Sample Request", FontFactory.GetFont("Tahoma", 15f, iTextSharp.text.Font.BOLD)));
        ...
        private void PrintBody()
        {
            ...
            if (_oSampleRequestDetails.Count > 0)
            {
                ...
                foreach (SampleRequestDetail oItem in _oSampleRequestDetails)
                {
                    ...
                    oPdfPCell = new PdfPCell(new Phrase("Measurement Unit :"+oItem.MUnitName+", Qty :"+oItem.Quantity.ToString("#,###.##"), _oFontStyle));
                    oPdfPCell.BackgroundColor = BaseColor.WHITE;
                    oPdfPCell.Border = 0; oPdfPCell.BorderWidthTop = 0; oPdfPCell.BorderWidthBottom = 0; oPdfPCell.BorderWidthLeft = 0.5f; oPdfPCell.BorderWidthRight = 0;
                    //oPdfPCell.FixedHeight = 40f;
                    oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                ...
                _nfixedHight = 400 - (float)nTableHeight;
                if (_nfixedHight > 0)
                {
