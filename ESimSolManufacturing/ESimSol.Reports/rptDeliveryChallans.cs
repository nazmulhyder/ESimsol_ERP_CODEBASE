...
namespace ESimSol.Reports
{
    ...
    public class rptDeliveryChallans
    {
        #region Declaration
        int _nTotalColumn = 8;
        Document _oDocument;
        ...
        public byte[] PrepareReport(DeliveryChallan oDeliveryChallan, string sMessage)
        {
            _oDeliveryChallans = oDeliveryChallan.DeliveryChallans;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Chllan No", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Cutomer Name", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Vehicale No", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if (_oDeliveryChallans.Count > 0)
            {
                foreach (DeliveryChallan oItem in _oDeliveryChallans)
                {
                    nCount++;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ChallanDateStr, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.GatePassNo, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
