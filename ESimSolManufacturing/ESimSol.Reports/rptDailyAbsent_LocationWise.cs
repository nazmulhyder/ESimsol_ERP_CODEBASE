...
{
    public class rptDailyAbsent_LocationWise
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintHaedRow(AttendanceDaily oAD)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Location : " + oAD.LocationName, _oFontStyle)); _oPdfPCell.Colspan = 9; _oPdfPCell.Border = 0;
        ...
        private void PrintAttendanceDaily(List<AttendanceDaily> oADs)
        {
            ...
            foreach (AttendanceDaily oItem in oADs)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.InTimeInString == "00:00" ? "-" : oItem.InTimeInString, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oItem.OutTimeInString == "00:00" ? "-" : oItem.OutTimeInString, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
