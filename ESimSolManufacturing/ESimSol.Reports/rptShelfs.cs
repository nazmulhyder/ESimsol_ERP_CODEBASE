...
namespace ESimSol.Reports
{
    public class rptShelfs
    {
        ...
        double _nSumShelfAmount = 0;
        string _sMessage = "";

        #endregion

        public byte[] PrepareReport(List<Shelf> oShelfs, Company oCompany, string sMessage)
        {
            _oShelfs = oShelfs;
            _oCompany = oCompany;
            _sMessage = sMessage;
            ...
            _oDocument.Open();
            //SL No,    Shelf No, Shelf Name,   Narration,  Date,   Authorized By,  Amount,Con. Rate,   Amount
            _oPdfPTable.SetWidths(new float[] { 45f, 60f, 230f, 200f});
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Shelf Name", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (Shelf oItem in _oShelfs)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.ShelfName, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
