...
{
    public class rptExportDocForBuying
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport_BeneficiaryCertificate(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, string sUnitName, BusinessUnit oBusinessUnit, int nPageSize)
        {
        ...
        private void PrintBody_BeneficiaryCertificate()
        {
            ...
            if (_oExportCommercialDoc.CommercialInvoiceDetails.Count > 5 && _oExportCommercialDoc.CommercialInvoiceDetails.Count <= 10)
            {
                nBlankSpace = 5f;
            }
            else if (_oExportCommercialDoc.CommercialInvoiceDetails.Count > 10)
            {
                nBlankSpace = 3f;
            }
            ...
            if (!string.IsNullOrEmpty(_oExportCommercialDoc.NoAndDateOfDoc))
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.InvoiceDateInstring, _oFontStyleBold));
                _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthRight = 0; _oPdfPCell.VerticalAlignment = Element.ALIGN_LEFT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                oPdfPTable.CompleteRow();
            }
            #endregion
            ...
            oExportPartyInfoDetails = ExportPartyInfoDetail.GetsByPartyAndBill(_oExportCommercialDoc.ApplicantID, _oExportCommercialDoc.ExportLCID, (int)EnumMasterLCType.MasterLC, 0);
            if (!String.IsNullOrEmpty(_oExportCommercialDoc.HSCode_Head) && !String.IsNullOrEmpty(_oExportCommercialDoc.HSCode))
            {
                ...
                oExportPartyInfoDetail.InfoCaption = _oExportCommercialDoc.HSCode_Head;
                oExportPartyInfoDetail.RefNo = _oExportCommercialDoc.HSCode;
                oExportPartyInfoDetails.Add(oExportPartyInfoDetail);
            }
            if (oExportPartyInfoDetails.Count > 0)
            {
                _oPdfPCell = new PdfPCell(this.ExportPartyInfo(false, oExportPartyInfoDetails));
            ...
            {
                _oPdfPCell = new PdfPCell(this.ProductWithOutPrice());
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                _oPdfPTable.CompleteRow();
            }
            #endregion
        ...
        public byte[] PrepareReport_DeliveryChallan(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, string sUnitName, BusinessUnit oBusinessUnit, int nPageSize)
        {
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.NoAndDateOfDoc + " " + _oExportCommercialDoc.InvoiceDateInstring, _oFontStyleBold));
            ...
            if (_oExportCommercialDoc.IsPrintGrossNetWeight)
            {
                ...
                if (_oExportCommercialDoc.DocHeader.ToUpper() == ("Delivery Challan").ToUpper())
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nTotalQty) + " " + _sUnitName + " & " + Math.Floor(Math.Ceiling(_nTotalQty / _oExportCommercialDoc.WeightPerBag)).ToString() + " Bales", _oFontStyle));
                    _oPdfPCell.Colspan = 2; _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                    oPdfPTable.CompleteRow();
                }
                else
        ...
        private PdfPTable ProductDetails()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.NetWeight + (!string.IsNullOrEmpty(_sUnitName) ? "(" + _sUnitName + ")" : ""), _oFontStyleBold));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.GrossWeight + (!string.IsNullOrEmpty(_sUnitName) ? "(" + _sUnitName + ")" : ""), _oFontStyleBold));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.BorderWidthBottom = 0.5f; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable1.AddCell(_oPdfPCell);
            oPdfPTable1.CompleteRow();

            List<CommercialInvoiceDetail> oCommercialInvoiceDetails = new List<CommercialInvoiceDetail>();
            oCommercialInvoiceDetails = _oExportCommercialDoc.CommercialInvoiceDetails;
            ...
            foreach (CommercialInvoiceDetail oitem in oCommercialInvoiceDetails)
            {
                ...
                nGrossWeight = oitem.InvoiceQty * 1.024; //Hard Code
                ...
                _nTotalRowCount++;
                _nTotalValue = _nTotalValue + (oitem.InvoiceQty * oitem.UnitPrice);
                _nTotalQty = _nTotalQty + oitem.InvoiceQty;
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nTotalQty) + " " + _sUnitName, _oFontStyleBold));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nTotalGrossWeight) + " " + _sUnitName, _oFontStyleBold));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.BorderWidthBottom = 0.5f; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable1.AddCell(_oPdfPCell);
            oPdfPTable1.CompleteRow();
        ...
        private PdfPTable ProductDetails_WU_CommercialInvoice()
        {
            ...
            foreach (CommercialInvoiceDetail oitem in oCommercialInvoiceDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oitem.InvoiceQty * oitem.UnitPrice), _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable1.AddCell(_oPdfPCell);
                ...
                //_nTotalNoOfBag = _nTotalNoOfBag + oitem.NoOfBa;
                //_nTotalWtPerBag = _nTotalWtPerBag + oitem.WtPerBag;
                _sMUnit_Two = oitem.UnitName;
            }
        ...
        public byte[] PrepareReport_CommercialInvoice(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, string sUnitName, BusinessUnit oBusinessUnit, int nPageSize)
        {
        ...
        public byte[] PrepareReport_BankForwarding(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, CommercialInvoice oCommercialInvoice, BusinessUnit oBusinessUnit, int nPageSize)
        {
        ...
        private void Print_BankForwarding()
        {
            ...
            oExportDocForwardings = ExportDocForwarding.Gets(_oExportCommercialDoc.MasterLCID,(int)EnumMasterLCType.MasterLC,  0);
        ...
        public byte[] PrepareReport_CertificateOfORGIN(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, string sUnitName, BusinessUnit oBusinessUnit, int nPageSize)
        {
        ...
        private void PrintBody_CertificateOfORGIN()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.CommercialInvoiceNo, _oFontStyle));
            ...
            if (_oExportCommercialDoc.IsPrintUnitPrice)
            {
                _oPdfPCell = new PdfPCell(this.ProductWithPrice());
            }
            else
            {
                _oPdfPCell = new PdfPCell(this.ProductWithPrice());
        ...
        public byte[] PrepareReport_BillOfExchange(ExportCommercialDoc oExportCommercialDoc, Company oCompany, int nPrintType, BusinessUnit oBusinessUnit, int nPageSize)
        {
            ...
            //if (oExportCommercialDoc.BOEImage != null)
            //{
            //    _oImag = iTextSharp.text.Image.GetInstance(oExportCommercialDoc.BOEImage, System.Drawing.Imaging.ImageFormat.Jpeg);
            //    _oImag.ScaleAbsolute(100f, 100f);
            //    _oImag.SetAbsolutePosition(150, 410);
            //    _cb.AddImage(_oImag);
            //    _cb.SetLiteral
            ...
            _oPdfPCell.Colspan = 2; _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthBottom = 0.5f; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.BorderWidthLeft = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable2.AddCell(_oPdfPCell);
            ...
            //_oFontStyle = FontFactory.GetFont("Tahoma", 17f, 1);
            //_oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.DocHeader, _oFontStyle));
            //_oPdfPCell.Border = 0; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            //PdfReader reader1 = new PdfReader(_oDocument.ToArray());
            ...
            //        cb.BeginText();
            //        cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "1", rect.Width / 2, rect.Height / 2, 45f);
            //        cb.EndText();
        ...
        private PdfPTable BOELeftPart(bool bIsTwo)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.CommercialInvoiceNo+ "                                           " + "Date:", _oFontStyleBold));
            _oPdfPCell.Border = 0;
            _oPdfPCell.BorderWidthTop = 0;
            //_oPdfPCell.FixedHeight = 5f;
            _oPdfPCell.BorderWidthBottom = 0;
        ...
        private void PrintBody_Bank_Forwarding()
        {
            ...
            //_oExportCommercialDoc.CommercialInvoiceDetails
            var nAmount = _oExportCommercialDoc.CommercialInvoiceDetails.Select(o => o.InvoiceQty * o.UnitPrice).Sum();
        ...
        private PdfPTable ExportPartyInfo(bool bIsBillOfExchange, List<ExportPartyInfoDetail> oExportPartyInfoDetails)
        {
            ...
            foreach (ExportPartyInfoDetail oItem in oExportPartyInfoDetails)
            {
                if (nCount > 0)
                {
                    if (nCount == oExportPartyInfoDetails.Count - 1)
                    {
                ...
                _oPhrase.Add(new Chunk(oItem.InfoCaption + " : ", _oFontStyleBold));
        ...
        private PdfPTable ShowNetWeight_WU()
        {
            ...
            if (_oExportCommercialDoc.IsPrintGrossNetWeight)
            {
                ...
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable2.AddCell(_oPdfPCell);
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nTotalQty + Math.Floor(Math.Round(((_nTotalQty * 1) / 100), 2))) + " " + _sUnitName, _oFontStyleBold));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable2.AddCell(_oPdfPCell);
                _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyleBold));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable2.AddCell(_oPdfPCell);
                oPdfPTable2.CompleteRow();
        ...
        private PdfPTable SetCommercialInvoice_Right()
        {
            ...
            if (!string.IsNullOrEmpty(_oExportCommercialDoc.NoAndDateOfDoc))
            {
                ...
                if (!string.IsNullOrEmpty(_oExportCommercialDoc.CommercialInvoiceNo))
                {
                    #region Balnk Space
                    _oPdfPCell = new PdfPCell(new Phrase(" ", _oFontStyleBold));
                    _oPdfPCell.Border = 0;
        ...
        private PdfPTable ProductWithPrice()
        {
            List<CommercialInvoiceDetail> oCommercialInvoiceDetails = new List<CommercialInvoiceDetail>();
            oCommercialInvoiceDetails = _oExportCommercialDoc.CommercialInvoiceDetails;
            ...
            if (oCommercialInvoiceDetails != null && oCommercialInvoiceDetails.Count > 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.QtyInLBS, _oFontStyle)); //Qty Caption from Setup
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.UnitPriceDes, _oFontStyle));//Unit Price Caption From Setup
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(_oExportCommercialDoc.ValueDes, _oFontStyle));//Amount Caption From Setup
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);
                ...
                foreach (CommercialInvoiceDetail oItem in oCommercialInvoiceDetails)
                {
                    ...
                    nTotalQty += oItem.InvoiceQty;
                    nTotalAmount += oItem.Amount;
                    _nTotalQty += oItem.InvoiceQty;
                    oDetailPdfPTable.CompleteRow();
        ...
        private PdfPTable ProductWithOutPrice()
        {
            List<CommercialInvoiceDetail> oCommercialInvoiceDetails = new List<CommercialInvoiceDetail>();
            oCommercialInvoiceDetails = _oExportCommercialDoc.CommercialInvoiceDetails;
            ...
            if (oCommercialInvoiceDetails != null && oCommercialInvoiceDetails.Count > 0)
            {
                ...
                _oPdfPCell.Rowspan = oCommercialInvoiceDetails.Count + 1; _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);
                ...
                {   
                    ...
                    sTempGoodDescription += "\nQuantity      : " + Global.MillionFormatActualDigit(oItem.InvoiceQty) + "  " + oItem.UnitName;
        ...
        private PdfPTable PloyProductWithPrice()
        {
            ...
            if (oCommercialInvoiceDetails != null && oCommercialInvoiceDetails.Count > 0)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Qty (" + oCommercialInvoiceDetails[0].UnitName + ")", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(oCommercialInvoiceDetails[0].UnitName, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oDetailPdfPTable.AddCell(_oPdfPCell);
