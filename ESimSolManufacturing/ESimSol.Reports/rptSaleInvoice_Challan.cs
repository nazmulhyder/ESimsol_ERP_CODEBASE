...
{
    public class rptSaleInvoice_Challan
    {
        ...
        public byte[] PrepareReport(SaleInvoice oSaleInvoice, VehicleChallan oVehicleChallan, Company oCompany)
        {
            _oCompany = oCompany;
            ...
            this.PrintCompanyHeader("NOTICE OF VEHICLE CHALLAN");
            this.PrintBody(oVehicleChallan);
        ...
        public void PrintBody(VehicleChallan oVehicleChallan)
        {
            ...
            this.PrintColumnHeader("CHALLAN DETAILS");
            this.PrintRow("Challan No", oVehicleChallan.ChallanNoFull);
            this.PrintRow("Challan Date", oVehicleChallan.ChallanDateSt);
            this.PrintRow("Issue Store", oVehicleChallan.OperationUnitName);
            this.PrintRow("Lot", oVehicleChallan.LotNo);
            this.PrintRow("Product", oVehicleChallan.ProductName);
            this.PrintRow("Remarks", oVehicleChallan.Note);
