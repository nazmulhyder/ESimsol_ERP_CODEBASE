...
{
    public class rptVoucherHalfPage
    {
        #region Declaration
        Document _oDocument;
        ...
        double _nAlreadyUsagesHeight = 180;
        double _nFullPageHeight = 421;
        ...
        public byte[] PrepareReport(Voucher oVoucher, bool bLogoPrint, List<SignatureSetup> oSignatureSetups)
        {
            ...
            _oDocument.SetMargins(45f, 25f, 20f, 5f);
        ...
        private void PrintBody(bool bLogoPrint)
        {
            ...
            _oPdfPCell.FixedHeight = 40f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.Border = 0; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
