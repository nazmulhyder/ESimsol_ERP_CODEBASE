...
{
    public class rptTradingPayments
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<TradingPayment> oTradingPayments, Company oCompany)
        {
            _oTradingPayments = oTradingPayments;
            _oCompany = oCompany;
            ...
            _oPdfPTable.SetWidths(new float[]   {   26f, //SL No
                                                    90f, //MR No
                                                    80f, //TradingPayment Date                                                    
                                                    140f, //Party Name 
                                                    100f, //TradingPayment Account
                                                    60f, //P. Method
                                                    100f, //Approved By
                                                    60f, //Currency 
                                                    100f //TradingPayment Amount
                                                });
            #endregion
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("TradingPayment List", _oFontStyle));
            _oPdfPCell.Colspan = 12;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Payment Account", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("P. Method", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (TradingPayment oItem in _oTradingPayments)
            {
                nCount++;
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.PaymentMethod.ToString(), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Global.TakaFormat(oItem.Amount), _oFontStyle));
