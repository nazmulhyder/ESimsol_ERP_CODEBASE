...
{
    public class rptVehicleReturnChallan
    {
        ...
        public byte[] PrepareReport(SaleInvoice oSaleInvoice, VehicleReturnChallan oVehicleReturnChallan, Company oCompany)
        {
            _oCompany = oCompany;
            ...
            this.PrintCompanyHeader("NOTICE OF VEHICLE RETURN CHALLAN");
            this.PrintBody(oVehicleReturnChallan);

            _oPdfPTable.HeaderRows = 1;

            //ESimSolPdfHelper.NewPageDeclaration(_oDocument,_oPdfPTable);

            //this.PrintCompanyHeader("NOTICE OF VEHICLE GATE PASS");
            //this.PrintBody(oVehicleReturnChallan);
        ...
        public void PrintCompanyHeader(string sCHearder)
        {
            PrintEmptyCell();
            PrintEmptyCell();
            ...
            _oPdfPCell = new PdfPCell(new Phrase(sCHearder, _oFontStyleRowHeader));
        ...
        public void PrintBody(VehicleReturnChallan oVehicleReturnChallan)
        {
            ...
            this.PrintColumnHeader("ReturnChallan DETAILS");
            this.PrintRow("ReturnChallan No", oVehicleReturnChallan.ReturnChallanNoFull);
            this.PrintRow("ReturnChallan Date", oVehicleReturnChallan.ReturnChallanDateSt);
            this.PrintRow("Issue Store", oVehicleReturnChallan.OperationUnitName);
            this.PrintRow("Lot", oVehicleReturnChallan.LotNo);
            this.PrintRow("Product", oVehicleReturnChallan.ProductName);
            this.PrintRow("Refund Amount", oVehicleReturnChallan.CurrencyName+" "+ Global.MillionFormat(oVehicleReturnChallan.Refund_Amount));
            this.PrintRow("Remarks", oVehicleReturnChallan.Note);
