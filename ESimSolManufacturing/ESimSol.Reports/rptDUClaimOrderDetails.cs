...
{
    public class rptDUClaimOrderDetails
    {
        #region Declaration
        int _nTotalColumn = 11;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<DUClaimOrder> oDUClaimOrders,List<DUClaimOrderDetail> oDUClaimOrderDetails, Company oCompany)
        {
            _oDUClaimOrders = oDUClaimOrders;
            _oDUClaimOrderDetails = oDUClaimOrderDetails;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Claim Order Details", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Claim No", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Date", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Claim Type", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Claim Qty", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Reason", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if (_oDUClaimOrders.Count > 0)
            {
                foreach(DUClaimOrder oItem in _oDUClaimOrders)
                {
                    ...
                    int nRowSpan = oTempDUClaimOrderDetails.Count();
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ClaimOrderNo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.OrderDateSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ClaimTypeSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ParentDONo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ContractorName, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    #endregion
                    ...
                    if (oTempDUClaimOrderDetails.Count > 0)
                    {
                        foreach (DUClaimOrderDetail oItemDetail in oTempDUClaimOrderDetails)
                        {
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.OrderQty.ToString("#,##0.00"), _oFontStyle));
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.Note, _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oDUClaimOrderDetails.Sum(x=>x.Qty).ToString("#,##0.00"), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
