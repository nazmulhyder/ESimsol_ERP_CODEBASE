...
namespace ESimSol.Reports
{
    ...
    public class rptSparePartsRequsition
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(SparePartsRequisition oSparePartsRequisition, Company oCompany, BusinessUnit oBusinessUnit)
        {
            _oSparePartsRequisition = oSparePartsRequisition;
            _oSparePartsRequisitionDetails = oSparePartsRequisition.SparePartsRequisitionDetails;
            _oCompany = oCompany;
            ...
            ESimSolPdfHelper.PrintHeader_Baly(ref _oPdfPTable, _oBusinessUnit, _oCompany, "Spare Parts Requsition Report", 1);
        ...
        public void PrintObject()
        {
            ...
            oPdfPTable.SetWidths(new float[] { 18, 15, 10, 18, 15, 25 });
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oSparePartsRequisition.SPStatusSt, _oFontStyleBold));
            _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Issue Date", _oFontStyleBold));
            _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(_oSparePartsRequisition.IssueDateSt, _oFontStyleBold));
            _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oSparePartsRequisition.Remarks, _oFontStyleBold)); _oPdfPCell.Colspan = 5;
            _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            #endregion
        ...
        public void DataList()
        {
            ...
            if (_oSparePartsRequisitionDetails.Count > 0)
            {
            ...
            int nCount = 1;
            foreach (SparePartsRequisitionDetail oItem in _oSparePartsRequisitionDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Math.Round(oItem.Quantity, 2).ToString(), _oFontStyle));
                _oPdfPCell.Border = iTextSharp.text.Rectangle.BOX; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oCPdfPTable.AddCell(_oPdfPCell);
