...
{
    public class rptExportDocPackingList
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Per Box in Dzn", _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Total Boxes", _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            //oExportBillDetails = ExportBillDetail.Gets(1, Global.CurrentSession);
            int nSL = 0;
            foreach (ExportBillDetail oitem in oExportBillDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oitem.ProductName, _oFontStyle));
                 ...
                 _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oitem.Qty), _oFontStyle));
                  ...
                  _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oitem.WtPerBag), _oFontStyle));
                 _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                ...
                oPdfPTable.CompleteRow();
                _nTotalBoxes = _nTotalBoxes + oitem.NoOfBag;
             
            }
            _oPdfPCell = new PdfPCell(new Phrase("Total Boxes", _oFontStyle));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(_nTotalBoxes), _oFontStyle));
