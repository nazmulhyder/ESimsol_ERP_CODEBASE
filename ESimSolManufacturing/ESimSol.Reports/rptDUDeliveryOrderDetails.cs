...
{
    public class rptDUDeliveryOrderDetails
    {
        #region Declaration
        int _nTotalColumn = 8;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<DUDeliveryOrder> oDUDeliveryOrders, List<DUDeliveryOrderDetail> oDUDeliveryOrderDetails, Company oCompany, bool bIsRateView)
        {
            _oDUDeliveryOrders = oDUDeliveryOrders;
            _oDUDeliveryOrderDetails = oDUDeliveryOrderDetails;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Delivery Order Details", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            if (_oDUDeliveryOrders.Count > 0)
            {
                foreach (DUDeliveryOrder oItem in _oDUDeliveryOrders)
                {
                    ...
                    int nRowSpan = oTempDUDeliveryOrderDetails.Count();
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.DONo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.DeliveryDateSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.DeliveryToName, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.OrderNo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ExportPINo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    #endregion
                    ...
                    if (oTempDUDeliveryOrderDetails.Count > 0)
                    {
                        foreach (DUDeliveryOrderDetail oItemDetail in oTempDUDeliveryOrderDetails)
                        {
                            ...
                            if (_bIsRateView)
                            {
                                _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.UnitPrice.ToString("#,##0.00"), _oFontStyle));
                                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                                _oPdfPCell = new PdfPCell(new Phrase((oItemDetail.Qty * oItemDetail.UnitPrice).ToString("#,##0.00"), _oFontStyle));
                                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oDUDeliveryOrderDetails.Sum(x => x.Qty).ToString("#,##0.00"), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                if (_bIsRateView)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(_oDUDeliveryOrderDetails.Select(x => (x.Qty * x.UnitPrice)).Sum().ToString("#,##0.00"), _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                }
