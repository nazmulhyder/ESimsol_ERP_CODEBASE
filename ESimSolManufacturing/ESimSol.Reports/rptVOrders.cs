...
namespace ESimSol.Reports
{
    public class rptVOrders
    {
        ...
        public byte[] PrepareReport(List<VOrder> oVOrders, Company oCompany)
        {
            _oVOrders = oVOrders;
            _oCompany = oCompany;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Voucher Order List", _oFontStyle));
            _oPdfPCell.Colspan = 7;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _oPdfPCell.Border = 0;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void PrintBody()
        {
            ...
            foreach (VOrder oItem in _oVOrders)
            {
                nCount++;
                ...
                _oPdfPCell = new PdfPCell(new Phrase(oItem.VOrderRefTypeSt, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
