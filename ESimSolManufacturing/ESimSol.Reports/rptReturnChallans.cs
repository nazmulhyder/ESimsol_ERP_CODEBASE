...
{
    public class rptReturnChallans
    {
        #region Declaration
        int _nTotalColumn = 6;
        Document _oDocument;
        ...
        public byte[] PrepareReport(ReturnChallan oReturnChallan, string sMessage)
        {
            _oReturnChallans = oReturnChallan.ReturnChallans;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Return Date", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Contractor Name", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if (_oReturnChallans.Count > 0)
            {
                foreach (ReturnChallan oItem in _oReturnChallans)
                {
                    nCount++;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ReturnDateStr, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
