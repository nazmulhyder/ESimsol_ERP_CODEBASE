...
namespace ESimSol.Reports
{
    public class rptPurchaseBill
    {
        ...
        public byte[] PrepareReport(PurchaseInvoice oPurchaseInvoice, Company oCompany, Contractor oContractor, BusinessUnit oBusinessUnit, List<ApprovalHead> oApprovalHeads)
        {
            ...
            //this.PrintHeader();
            ESimSolPdfHelper.PrintHeader_Audi(ref _oPdfPTable, _oBusinessUnit, _oCompany, new string[] { "Purchase Invoice", "Audi Service Dhaka", "Audi", "429/432, Tejgaon I/A, Dhaka-1208", "Service" },0);
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Bill No", _oFontStyle_Bold));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseInvoice.DateofBill.ToString("MMMM dd, yyyy"), _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthLeft = 0; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseInvoice.PurchaseInvoiceNo, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthLeft = 0; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Payment Mode", _oFontStyle_Bold));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthLeft = 0; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();

            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseInvoice.RefNo, _oFontStyle));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseInvoice.InvoicePaymentMode.ToString(), _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0; _oPdfPCell.BorderWidthBottom = 0.5f; _oPdfPCell.BorderWidthLeft = 0; _oPdfPCell.BorderWidthRight = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            if (_oPurchaseInvoice.InvoiceType != EnumPInvoiceType.Advance)
            {
                ...
                oPdfPTable.SetWidths(new float[] { 20f,85f, 195f, 45f, 65f, 30f, 40f, 60f, 75f });
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Model No", _oFontStyle_Bold));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell.Border = 0; _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.BorderWidthBottom = 0; _oPdfPCell.BorderWidthLeft = 0.5f; _oPdfPCell.Colspan = nTempColumn - 2; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(_oPurchaseInvoice.CurrencySymbol + " " + Global.MillionFormat(nTotalValue), _oFontStyle_Bold));
                _oPdfPCell.Border = 0; _oPdfPCell.Colspan = 2; _oPdfPCell.BorderWidthTop = 0.5f; _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                oPdfPTable.CompleteRow();

                _oPdfPCell = new PdfPCell(new Phrase("Amount In Word :  " + Global.AmountInWords(nTotalValue, _oPurchaseInvoice.CurrencyBFDP, _oPurchaseInvoice.CurrencyBADP), _oFontStyle));
            ...
            else
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Amount In Word :  " + Global.TakaWords(nTotalValue), _oFontStyle));
        ...
        public void PrintRemarks()
        {
            ...
            #region Row
            _oPdfPCell = new PdfPCell(new Phrase("Remarks : " + _oPurchaseInvoice.Note, _oFontStyle));
            _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            #endregion
