...
{
    public class rptDiscontinuedEmployeeWithImage
    {
        #region Declaration
        ...
        public byte[] PrepareReport(Employee oEmployee)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 25f,100, 100f, 70f, 65f, 55f, 60f, 50f });
            #endregion
        ...
        #region Report Body
        private void HeaderColumnShow(string DepartmentName)
        {
            _oFontStyle = FontFactory.GetFont("Tahoma", 10f, iTextSharp.text.Font.BOLD);
            _oPdfPCell = new PdfPCell(new Phrase("SEC : " + DepartmentName, _oFontStyle)); _oPdfPCell.Colspan = 8; _oPdfPCell.Border = 0;
        ...
        private void PrintBody()
        {
            ...
            foreach (Department oDepartmentItem in _oDepartments)
            {
                ...
                if (oEmployees.Count > 0)
                {
                    ...
                    HeaderColumnShow(oEmployees[0].DepartmentName);
                    ...
                    foreach (Employee oEmployeeItem in oEmployees)
                    {
                        ...
                        if (oEmployeeItem.EmployeePhoto != null)
                        {
                            _oImag = iTextSharp.text.Image.GetInstance(oEmployeeItem.EmployeePhoto, System.Drawing.Imaging.ImageFormat.Jpeg);
                        ...
                        {
                            _oPdfPCell = new PdfPCell(new Phrase("", _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                        }

                        _oPdfPCell = new PdfPCell(new Phrase(oEmployeeItem.Name, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        ...
                        _oPdfPCell = new PdfPCell(new Phrase(oEmployeeItem.DesignationName, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);


                        _oPdfPCell = new PdfPCell(new Phrase(oEmployeeItem.Code, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);


                        _oPdfPCell = new PdfPCell(new Phrase(oEmployeeItem.DateOfBirthInString, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);


                        _oPdfPCell = new PdfPCell(new Phrase(oEmployeeItem.DateOfJoinInString, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);


                        _oPdfPCell = new PdfPCell(new Phrase(_oEmployeeSettlements.Where(x => x.EmployeeID == oEmployeeItem.EmployeeID).First().EffectDateInString, _oFontStyle)); _oPdfPCell.FixedHeight = 65;
                        _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
