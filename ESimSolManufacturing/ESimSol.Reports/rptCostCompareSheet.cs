...
using System.Linq;
    ...
    namespace ESimSol.Reports
    {
        ...
        public class rptCostCompareSheet
        {
            #region Declaration
            Document _oDocument;
            ...
            List<CostSheetDetail> _oActualCostSheetYarnDetails = new List<CostSheetDetail>();
            List<CostSheetDetail> _oActualCostSheetAccessoriesDetails = new List<CostSheetDetail>();
            ...
            public byte[] PrepareReport(CostSheet oCostSheet, Company oCompany)
            {
                ...
                _oOrderRecap = _oCostSheet.OrderRecap;
                ...
                _oActualCostSheetYarnDetails = oCostSheet.ActualCostSheetYarnDetails;
                _oActualCostSheetAccessoriesDetails = oCostSheet.ActualCostSheetAccessoriesDetails;
                _oCompany = oCompany;
            ...
            private void PrintHeader()
            {
                ...
                #region ReportHeader
                _oFontStyle = FontFactory.GetFont("Tahoma", 12f, iTextSharp.text.Font.BOLD);
                _oPdfPCell = new PdfPCell(new Phrase("Compare Sheet ", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _oPdfPCell.Border = 0;
                _oPdfPCell.BackgroundColor = BaseColor.WHITE;
                _oPdfPCell.ExtraParagraphSpace = 5f;
            ...
            private void PrintBody()
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(": " +_oOrderRecap.TotalQuantity , _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
                ...
                #region Assumption Cost Heading
                _oFontStyle = FontFactory.GetFont("Tahoma", 9f, iTextSharp.text.Font.BOLD);
                _oPdfPCell = new PdfPCell(new Phrase("Assumption Cost", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _oPdfPCell.Border = 0;
                _oPdfPCell.BackgroundColor = BaseColor.WHITE;
                _oPdfPCell.ExtraParagraphSpace = 7f;
                ...
                #region Yarn Value
                _oPdfPCell = new PdfPCell(GetYarnDetails(_oCostSheetYarnDetails,true));
                ...
                #region Assumption Accessories Details
                ...
                _oPdfPCell = new PdfPCell(GetAccessoriesDetails(_oCostSheetAccessoriesDetails,true));
                ...
                if(_oActualCostSheetYarnDetails.Count>0) // SEt Actual Values
                {
                    _oCostSheet.WeightPerDozen = _oActualCostSheetYarnDetails[0].ActualGarmentsWeight;
                    _oCostSheet.ProcessLoss = _oActualCostSheetYarnDetails[0].ActualProcessLoss;
                }
                else
                {
                    _oCostSheet.WeightPerDozen = 0;
                    _oCostSheet.ProcessLoss = 0;
                }
                ...
                #region Actual Cost Heading
                _oFontStyle = FontFactory.GetFont("Tahoma", 9f, iTextSharp.text.Font.BOLD);
                _oPdfPCell = new PdfPCell(new Phrase("Actual Cost", _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _oPdfPCell.Border = 0;
                _oPdfPCell.BackgroundColor = BaseColor.WHITE;
                _oPdfPCell.ExtraParagraphSpace = 7f;
                ...
                #region Actual yarn Details

                 oYarnPTable = new PdfPTable(3);
                oYarnPTable.WidthPercentage = 100;
                oYarnPTable.HorizontalAlignment = Element.ALIGN_LEFT;
                oYarnPTable.DefaultCell.Border = iTextSharp.text.Rectangle.NO_BORDER;
                oYarnPTable.SetWidths(new float[] { 365f, 20f, 180f });
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Actual Consumption :", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);
                oYarnPTable.CompleteRow();
                #endregion

                #region Yarn Value
                _oPdfPCell = new PdfPCell(GetYarnDetails(_oActualCostSheetYarnDetails,false));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);
                ...
                #region Actual Accessories Details
                ...
                _oPdfPCell = new PdfPCell(new Phrase("Actual Total Costing :", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);
                oYarnPTable.CompleteRow();
                #endregion

                #region Accessores Value
                _oPdfPCell = new PdfPCell(GetAccessoriesDetails(_oActualCostSheetAccessoriesDetails,false));
                _oPdfPCell.Border = 0; _oPdfPCell.VerticalAlignment = Element.ALIGN_TOP; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(" ", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(GetActualTotalCostingInfo());
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnPTable.AddCell(_oPdfPCell);
                oYarnPTable.CompleteRow();
                #endregion
            ...
            private PdfPTable GetYarnDetails(List<CostSheetDetail> oCostSheetYarnDetails, bool bIsAssumption)
            {
                ...
                string sCostCaption = "";
                if (bIsAssumption == true)
                {
                    sCostCaption = "Estmd. Cost";
                }
                else
                {
                    sCostCaption = "Actual Cost";
                }
                ...
                _oPdfPCell = new PdfPCell(new Phrase(sCostCaption, _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oYarnDetailsPdfPTable.AddCell(_oPdfPCell);
                oYarnDetailsPdfPTable.CompleteRow();

                #endregion
                _oFontStyle = FontFactory.GetFont("Tahoma", 8f, iTextSharp.text.Font.NORMAL);
                if (oCostSheetYarnDetails.Count > 0)
                {
                    int nCount = 0;
                    foreach (CostSheetDetail oItem in oCostSheetYarnDetails)
                    {
                        nCount++;
            ...
            private PdfPTable GetAccessoriesDetails(List<CostSheetDetail> oCostSheetAccessoriesDetails, bool bIsAssumption)
            {
                ...
                {
                    int nCount = 0;
                    foreach (CostSheetDetail oItem in oCostSheetAccessoriesDetails)
                    {
                        nCount++;
            ...
            private PdfPTable GetActualTotalCostingInfo()
            {
                PdfPTable oTempCostingPdfPTable = new PdfPTable(2);
                oTempCostingPdfPTable.HorizontalAlignment = Element.ALIGN_LEFT;
                oTempCostingPdfPTable.DefaultCell.Border = iTextSharp.text.Rectangle.NO_BORDER;
                ...
                double totalFabricPerLBS = 0;
                if (_oActualCostSheetYarnDetails.Count > 0)
                {
                    FabriPrice = _oActualCostSheetYarnDetails.Sum(x => x.EstimatedCost);
                    totalFabricPerLBS = _oActualCostSheetYarnDetails[0].ActualGarmentsWeight + _oActualCostSheetYarnDetails[0].ActualProcessLoss;
                }
                if(_oActualCostSheetAccessoriesDetails.Count>0)
                {
                    AccessoriesPrice = _oActualCostSheetAccessoriesDetails.Sum(x => x.EstimatedCost);
                }
                #region Total Fabric Cost
                _oPdfPCell = new PdfPCell(new Phrase("Total Fabric Cost", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oTempCostingPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(": " + _oCostSheet.CurrencySymbol + " " + Global.MillionFormat(FabriPrice * totalFabricPerLBS) + " /Dozen", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oTempCostingPdfPTable.AddCell(_oPdfPCell);
                oTempCostingPdfPTable.CompleteRow();
                #endregion
                ...
                _oPdfPCell = new PdfPCell(new Phrase(": " + _oCostSheet.CurrencySymbol + " " + Global.MillionFormat(AccessoriesPrice) + " /Dozen", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oTempCostingPdfPTable.AddCell(_oPdfPCell);
                oTempCostingPdfPTable.CompleteRow();
                #endregion
                ...
                _oPdfPCell = new PdfPCell(new Phrase(": " + _oCostSheet.CurrencySymbol + " " + Global.MillionFormat(_oOrderRecap.CMValue) + " /Dozen", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oTempCostingPdfPTable.AddCell(_oPdfPCell);
                #endregion
                ...
                _oPdfPCell = new PdfPCell(new Phrase(": " + _oCostSheet.CurrencySymbol + " " + Global.MillionFormat(_oOrderRecap.UnitPrice) + " /Pcs", _oFontStyle));
                _oPdfPCell.Border = 0; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oTempCostingPdfPTable.AddCell(_oPdfPCell);
                #endregion
