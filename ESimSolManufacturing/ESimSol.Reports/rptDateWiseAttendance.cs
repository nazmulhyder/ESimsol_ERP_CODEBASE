...
{
    public class rptDateWiseAttendance
    {
        #region Declaration
        int _nColumns = 0;
        int _nPageWidth = 0;
        ...
        public byte[] PrepareReport(AttendanceDaily oAttendanceDaily, List<BusinessUnit> oBusinessUnits)
        {
            ...
            float[] tablecolumns = new float[_nColumns+12];
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("HD", _oFontStyle)); _oPdfPCell.Rowspan = 2;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Off", _oFontStyle)); _oPdfPCell.Rowspan = 2;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("LATE", _oFontStyle)); _oPdfPCell.Rowspan = 2;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("EARLY", _oFontStyle)); _oPdfPCell.Rowspan = 2;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void BodyMake(List<AttendanceDaily> oADs)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase((nWorkingDay > 0 ? nWorkingDay.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nAbsent > 0 ? nAbsent.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nHDay > 0 ? nHDay.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nDODay > 0 ? nDODay.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nLDay > 0 ? nLDay.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nSHLDay > 0 ? nSHLDay.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nLateArrivalMinute > 0 ? nLateArrivalMinute.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((nEarlyDepartureMinute > 0 ? nEarlyDepartureMinute.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase((_nDays > 0 ? _nDays.ToString() : "-"), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        public void AttendanceExist(AttendanceDaily oADItem)
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(oADItem.AttStatusInStringInShort, _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if ((oADItem.InTimeInString != "-" || oADItem.OutTimeInString != "-") && oADItem.IsHoliday== true)
            {
                //_oPdfPCell = new PdfPCell(new Phrase("P,HD", _oFontStyle));
                //_oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                
                
                nHDay++;
            }
            if ((oADItem.InTimeInString != "-" || oADItem.OutTimeInString != "-") && oADItem.IsDayOff == true)
            {
                //_oPdfPCell = new PdfPCell(new Phrase("P,Off", _oFontStyle));
                //_oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                
                
                nDODay++;
            }
            if ((oADItem.InTimeInString != "-" || oADItem.OutTimeInString != "-") && oADItem.LateArrivalMinute > 0)
            {
                //_oPdfPCell = new PdfPCell(new Phrase("L,P", _oFontStyle));
                //_oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                
                
                nLateArrivalMinute++;
            }
            if ((oADItem.InTimeInString != "-" || oADItem.OutTimeInString != "-") && oADItem.EarlyDepartureMinute > 0)
            {
                //_oPdfPCell = new PdfPCell(new Phrase("P,E", _oFontStyle));
                //_oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                
                
                nEarlyDepartureMinute++;
            }
            if (oADItem.InTimeInString == "-" && oADItem.OutTimeInString == "-" && oADItem.IsOSD== false && oADItem.IsDayOff == false && oADItem.IsHoliday == false && oADItem.IsLeave == false)
            {
