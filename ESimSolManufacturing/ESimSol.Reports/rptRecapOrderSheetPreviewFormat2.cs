...
{
    public class rptRecapOrderSheetPreviewFormat2
    {
        #region Declaration
        Document _oDocument;
        ...
        Company _oCompany = new Company();
         ...
         public byte[] PrepareReportFormat2(OrderRecap oOrderRecap)
         {
             ...
             this.PrintHeaderFormat2();
             this.PrintBodyFormat2();
         ...
         private void PrintHeaderFormat2()
         {
             #region ReportHeader
         ...
         private void PrintBodyFormat2()
         {
             ...
             _oPdfPCell = new PdfPCell(GetAccessoriesTableFormat2());
             ...
             _oFontStyle = FontFactory.GetFont("Tahoma", 8.5f, iTextSharp.text.Font.NORMAL);
             oPdfPTable.SetWidths(new float[] { 360f, 220f, 200f });
             ...
             _oFontStyle = FontFactory.GetFont("Tahoma", 11f, 1);
             _oPdfPCell = new PdfPCell(GetAssortmentSizeColumnName(false));
             _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
             _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
             _oPdfPCell.BorderWidthLeft = .5f;
             ...
             if (_oOrderRecap.TechnicalSheetFrontImage.FrontImage != null)
             {
                 ...
                 _oImag.ScaleAbsolute(180f, 155f);
                 _oPdfPCell = new PdfPCell(_oImag);
                 _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                 _oPdfPCell.VerticalAlignment = Element.ALIGN_BOTTOM;
                 _oPdfPCell.BorderWidthLeft = 0.5f;
             ...
             _oFontStyle = FontFactory.GetFont("Tahoma", 8.5f, iTextSharp.text.Font.NORMAL);
             _oPdfPCell = new PdfPCell(new Phrase("Marchandiser                                                                               MER.Manager                                                                           Q.C Manager                                                                             Managinng Director", _oFontStyle));
             _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
             _oPdfPCell.VerticalAlignment = Element.ALIGN_BOTTOM;
             _oPdfPCell.Border = 0;
             _oPdfPCell.BackgroundColor = BaseColor.WHITE;
         ...
         private PdfPTable GetAccessoriesTableFormat2()
         {
        ...
        private PdfPTable GetAssortmentSizeColumnName(bool bIsSolidAssortment)//for default and format 1
        {
            PdfPTable oPdfPTable = new PdfPTable(3);
            oPdfPTable.WidthPercentage = 100;
            oPdfPTable.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            //_oPdfPCell = new PdfPCell(new Phrase(_nTotalAssortmentQty.ToString() + " PCS", _oFontStyle));
            //_oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            //oPdfPTable.CompleteRow();
        ...
        private PdfPTable  GetYarnAndSizeTable()
        {
            ...
            _oPdfPCell = new PdfPCell(GetYarnTable());
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BorderWidthLeft = .5f; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
        ...
        private PdfPTable GetYarnTable()
        {
            PdfPTable oPdfPTable = new PdfPTable(7);
            oPdfPTable.WidthPercentage = 100;
            oPdfPTable.HorizontalAlignment = Element.ALIGN_LEFT;
            _oFontStyle = FontFactory.GetFont("Tahoma", 9f, iTextSharp.text.Font.BOLD);
            oPdfPTable.SetWidths(new float[] { 100f, 100f, 80f, 50f, 70f, 90f, 90f });
