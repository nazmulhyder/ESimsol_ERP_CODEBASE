...
{
    public class rptAdjustmentRequisitionSlips
    {
        #region Declaration
        int _nTotalColumn = 9;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<AdjustmentRequisitionSlip> oAdjustmentRequisitionSlips, List<AdjustmentRequisitionSlipDetail> oAdjustmentRequisitionSlipDetails, Company oCompany)
        {
            _oAdjustmentRequisitionSlips = oAdjustmentRequisitionSlips;
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Adjustment Requisition Slip Details", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            if (_oAdjustmentRequisitionSlips.Count > 0)
            {
                foreach (AdjustmentRequisitionSlip oItem in _oAdjustmentRequisitionSlips)
                {
                    ...
                    int nRowSpan = oTempAdjustmentRequisitionSlipDetails.Count();
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ARSlipNo, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.DateSt, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.PreaperByName, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.AprovedByName, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                    _oPdfPCell = new PdfPCell(new Phrase(oItem.WUName, _oFontStyle)); _oPdfPCell.Rowspan = nRowSpan;
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                    ...
                    if (oTempAdjustmentRequisitionSlipDetails.Count > 0)
                    {
                        foreach (AdjustmentRequisitionSlipDetail oItemDetail in oTempAdjustmentRequisitionSlipDetails)
                        {
                            ...
                            _oPdfPCell = new PdfPCell(new Phrase(oItemDetail.Qty.ToString("#,##0.00;(#,##0.00)"), _oFontStyle));
                            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oAdjustmentRequisitionSlipDetails.Sum(x => x.Qty).ToString("#,##0.00"), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
