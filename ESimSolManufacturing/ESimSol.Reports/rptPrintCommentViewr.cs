...
{
    public class rptPrintCommentViewr
    {
        #region Declaration
        int _nTotalColumn = 1;
        Document _oDocument;
        ...
        //List<DispoProductionCommentViewer> _oDispoProductionCommentViewers = new List<DispoProductionCommentViewer>();
        ...
        public byte[] PrepareReport(List<DispoProductionComment> oDispoProductionComments, Company oCompany)
        {
            ...
            //_oDispoProductionCommentViewers = oDispoProductionCommentViewers;
            _oCompany = oCompany;
        ...
        {
            this.PrintHeaderDetail("Comment Viewers List", " ", " ");
            this.SetData();
        }
        #endregion
        ...
        private void SetData()
        {
            ...
            foreach (DispoProductionComment oItem in _oDispoProductionComments)
            {
                ...
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Name", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Seen Date", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
                ...
                #region data
                nSLNo = 0;
                foreach (var oDetail in oItem.DispoProductionCommentViewers)
                {
                    oPdfPTable = new PdfPTable(3);
                    oPdfPTable.SetWidths(new float[] { 10f, 60f, 30f });
                    ...
                    ESimSolItexSharp.SetCellValue(ref oPdfPTable, oDetail.UserName, 0, 0, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyle);
                    ESimSolItexSharp.SetCellValue(ref oPdfPTable, oDetail.DBServerDateTimeInString, 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyle);
                    oPdfPTable.CompleteRow();
                    ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
                }
                #endregion
