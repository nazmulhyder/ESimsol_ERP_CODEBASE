...
{
    public class rptDailyAttendance_DepartmentWise
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(AttendanceDaily oAttendanceDaily, string format, List<BusinessUnit> oBusinessUnits)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 18f, 45f, 105f, 80f,30f, 28f, 28f, 40f, 35f, 35f, 35f, 28f });
            #endregion
        ...
        private void PrintBody()
        {
            ...
            else
            {
                ...
                while (_oAttendanceDailys.Count > 0)
                {
                    ...
                    oTempAttendanceDailys = _oAttendanceDailys.Where(x => x.DepartmentID == _oAttendanceDailys[0].DepartmentID).OrderBy(x => x.EmployeeCode).ToList();
                    //oTempDAs.AddRange(oTempAttendanceDailys);
                    PrintAttendanceDaily(oTempAttendanceDailys);
                    _oAttendanceDailys.RemoveAll(x => x.DepartmentID == oTempAttendanceDailys[0].DepartmentID);
                }
                PrintGT();
            }
        ...
        {
            _oPdfPCell = new PdfPCell(new Phrase(" ", _oFontStyle)); _oPdfPCell.Colspan = 12; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 8;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();

            _oFontStyle = FontFactory.GetFont("Arial Black", 8f, iTextSharp.text.Font.BOLD);
            _oPdfPCell = new PdfPCell(new Phrase("Business Unit : " + oAD.BUName + " ,Location : " + oAD.LocationName + " ,Department : " + oAD.DepartmentName, _oFontStyle)); _oPdfPCell.Colspan = 12; _oPdfPCell.Border = 0;
            ...
            _oPdfPCell = new PdfPCell(new Phrase("E. LIVING", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintAttendanceDaily(List<AttendanceDaily> oADs)
        {
            ...
            _oFontStyle = FontFactory.GetFont("Arial Black", 8f, iTextSharp.text.Font.BOLD);
            _oPdfPCell = new PdfPCell(new Phrase("Business Unit : " + oADs[0].BUName + " ,Location : " + oADs[0].LocationName + " ,Department : " + oADs[0].DepartmentName, _oFontStyle)); _oPdfPCell.Colspan = 12;
        ...
        private void PrintGT()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(OT.ToString(), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.Colspan = 3; _oPdfPTable.AddCell(_oPdfPCell);
