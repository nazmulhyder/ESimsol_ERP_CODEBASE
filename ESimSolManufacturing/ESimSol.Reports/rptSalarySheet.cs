...
namespace ESimSol.Reports
{
    ...
    public class rptSalarySheet
    {
        ...
        public byte[] PrepareReport(EmployeeSalary oEmployeeSalary)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 20f, 240f, 110f, 70f, 120f, 65f, 80f, 60f, 90f, 70f, 65f, 65f });
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Pro./Bonus/Short Fall", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            double nNoWorkAllowancePerPage = 0;
            ...
            double nTotalNoWorkAllowance = 0;
            ...
            foreach (EmployeeSalary oEmpSalaryItem in _oEmployeeSalarys)
            {
                ...
                nNoWorkAllowancePerPage = nNoWorkAllowancePerPage + oEmpSalaryItem.TotalNoWorkDayAllowance;
                ...
                nTotalNoWorkAllowance = nTotalNoWorkAllowance + oEmpSalaryItem.TotalNoWorkDayAllowance;
                ...
                if (nCount == 8 * nPageCount)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nNoWorkAllowancePerPage), _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(nTotalNoWorkAllowance), _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
