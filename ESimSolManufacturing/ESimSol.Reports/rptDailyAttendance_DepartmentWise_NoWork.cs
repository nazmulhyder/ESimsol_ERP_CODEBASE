...
{
    public class rptDailyAttendance_DepartmentWise_NoWork
    {
        #region Declaration
        Document _oDocument;
        ...
        public byte[] PrepareReport(AttendanceDaily oAttendanceDaily)
        {
            ...
            if (_oAttendanceDailys.Count > 0)
            {
                ...
                else if (oAttendanceDaily.ErrorMessage == "NoWork")
                {
                    sHeader = "No Work Employee Of " + sDate;
                }
                else
                {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 20f, 90f, 70f, 80f, 50f});
            #endregion
        ...
        {
            _oPdfPCell = new PdfPCell(new Phrase(" ", _oFontStyle)); _oPdfPCell.Colspan = 5; _oPdfPCell.Border = 0; _oPdfPCell.FixedHeight = 15;
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();

            _oFontStyle = FontFactory.GetFont("Arial Black", 8f, iTextSharp.text.Font.BOLD);
            _oPdfPCell = new PdfPCell(new Phrase("Department : " + oAD.DepartmentName, _oFontStyle)); _oPdfPCell.Colspan = 5; _oPdfPCell.Border = 0;
