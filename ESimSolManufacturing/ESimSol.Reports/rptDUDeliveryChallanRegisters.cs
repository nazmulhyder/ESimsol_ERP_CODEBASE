...
namespace ESimSol.Reports
{
    ...
    public class rptDUDeliveryChallanRegisters
    {
        #region Declaration
        PdfWriter _oWriter;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<DUDeliveryChallanRegister> oDUDeliveryChallanRegisters, Company oCompany, EnumReportLayout eReportLayout, string sDateRange)
        {
            _oDUDeliveryChallanRegisters = oDUDeliveryChallanRegisters;
            _oCompany = oCompany;

            if(_oDUDeliveryChallanRegisters.Count>0)
            {
                _sMunit = _oDUDeliveryChallanRegisters[0].MUnit;
            }
        ...
        public PdfPTable PrepareExcel(List<DUDeliveryChallanRegister> oDUDeliveryChallanRegisters, Company oCompany, EnumReportLayout eReportLayout, string sDateRange)
        {
            _oDUDeliveryChallanRegisters = oDUDeliveryChallanRegisters;
            _oCompany = oCompany;
            ...
            {
                this.PrintHeader("Date Wise Challan Register", sDateRange);
                this.PrintBodyDateWiseDetails();
                _oPdfPTable.HeaderRows = 3;
            }
            ...
            {
                this.PrintHeader("Party Wise Challan Register", sDateRange);
                this.PrintBodyPartyWiseDetails();
                _oPdfPTable.HeaderRows = 3;
            }
            else if (eReportLayout == EnumReportLayout.ProductWise)
            {
                this.PrintHeader("Product Wise Challan Register", sDateRange);
                this.PrintBodyProductWise();
                _oPdfPTable.HeaderRows = 3;
            }
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
              ...
              _oPdfPCell = new PdfPCell(new Phrase("Buyer Concern", _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
            ...
            foreach (DUDeliveryChallanRegister oItem in _oDUDeliveryChallanRegisters)
            {
                if (nDUDeliveryChallanID != oItem.DUDeliveryChallanID)
                {
                    ...
                    nCount++;
                    nRowSpan = _oDUDeliveryChallanRegisters.Where(ChallanR => ChallanR.DUDeliveryChallanID == oItem.DUDeliveryChallanID).ToList().Count + 1;
                ...
                nDUDeliveryChallanID = oItem.DUDeliveryChallanID;
        ...
        private void PrintBodyDateWiseDetails()
        {
            ...
            int nDUDeliveryChallanID = 0; DateTime dChallanDate = DateTime.MinValue; int nCount = 0; int nRowSpan = 0;
            ...
            foreach (DUDeliveryChallanRegister oItem in _oDUDeliveryChallanRegisters)
            {
                if (dChallanDate.ToString("dd MMM yyyy") != oItem.ChallanDate.ToString("dd MMM yyyy"))
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase("Order Type ", _oFontStyleBold));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; oPdfPTable.AddCell(_oPdfPCell);
                ...
                if (nDUDeliveryChallanID != oItem.DUDeliveryChallanID)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.OrderType.ToString(), _oFontStyle));
                    _oPdfPCell.Rowspan = nRowSpan; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
        ...
        private void PrintBodyPartyWiseDetails()
        {
            ...
            int nDUDeliveryChallanID = 0; string sBuyerName = ""; int nCount = 0; int nRowSpan = 0; 
