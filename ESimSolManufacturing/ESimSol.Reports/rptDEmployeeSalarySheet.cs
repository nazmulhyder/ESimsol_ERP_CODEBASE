...
namespace ESimSol.Reports
{
    ...
    public class rptDEmployeeSalarySheet
    {
        #region Declaration
        ...
        public byte[] PrepareReport(EmployeeSalary oEmployeeSalary)
        {
            ...
            //===============
            _nColumns = _oSalaryHeads.Count + 21;
        ...
        private void PrintBody()
        {
            ...
            foreach (EmployeeSalary oESItem in _oEmployeeSalarys)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oESItem.NetAmount - oESItem.AddShort), _oFontStyle));
                _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
