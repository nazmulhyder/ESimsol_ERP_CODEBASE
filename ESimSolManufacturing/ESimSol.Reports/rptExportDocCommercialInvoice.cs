...
{
    public class rptExportDocCommercialInvoice
    {
        #region Declaration
        Document _oDocument;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Total Amount", _oFontStyleBold));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
            oPdfPTable.CompleteRow();
            ...
            foreach (ExportBillDetail oitem in oExportBillDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(Global.MillionFormat(oitem.Qty) + " " + oitem.MUName, _oFontStyle));
            ...
            int nRequiredRow = 15 - (oExportBillDetails.Count);
            ...
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.Colspan = 5; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; oPdfPTable.AddCell(_oPdfPCell);
