...
{
    public class rptRouteSheetDCOutList
    {
        #region Declaration
        int _nColumns = 1;
        Document _oDocument;
        ...
        public byte[] PrepareReport(List<RouteSheetDCOut> oRouteSheetDCOuts, Company oCompany, string sDateRange)
        {
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("CHEMICAL & DYESTAFF REPORT", _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            oPdfPTable.SetWidths(new float[] { 16f, 40f, 120f, 20f, 40f, 40f, 40f, 40f });

            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "#SL", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Product Code", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Dyes/Chemical Name", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
            ...
            ESimSolItexSharp.SetCellValue(ref oPdfPTable, "Addition Qty", 0, 0, Element.ALIGN_CENTER, BaseColor.WHITE, true, 0, _oFontStyleBold);
        ...
        private void SetData()
        {
            ...
            var data = _oRouteSheetDCOuts.GroupBy(x => new { x.ProductType, x.ProductTypeSt }, (key, grp) => new
            {
                ProductTypeSt = key.ProductTypeSt,
                Results = grp.ToList()
            });
            ...
            foreach (var oData in data)
            {
                ...
                oPdfPTable.SetWidths(new float[] { 16f, 40f, 120f, 20f, 40f, 40f, 40f, 40f });
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, oData.ProductTypeSt, 0, oPdfPTable.NumberOfColumns, Element.ALIGN_LEFT, BaseColor.WHITE, true, 0, _oFontStyleBold);
                oPdfPTable.CompleteRow();
                ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
                foreach (var oItem in oData.Results)
                {
                    ...
                    ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oItem.QtyAdd), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyle);
                    ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oItem.QtyRet), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyle);
                    ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oItem.Balance), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyle);
                    oPdfPTable.CompleteRow();
                    ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
                }
                ...
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oData.Results.Sum(x => x.Qty)), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyleBold);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oData.Results.Sum(x => x.QtyAdd)), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyleBold);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oData.Results.Sum(x => x.QtyRet)), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyleBold);
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, Global.MillionFormat(oData.Results.Sum(x => x.Balance)), 0, 0, Element.ALIGN_RIGHT, BaseColor.WHITE, true, 0, _oFontStyleBold);
                oPdfPTable.CompleteRow();
                ESimSolItexSharp.SetCellValue(ref oPdfPTable, " ", 0, oPdfPTable.NumberOfColumns, Element.ALIGN_LEFT, BaseColor.WHITE, false, 15, _oFontStyle);
                oPdfPTable.CompleteRow();
                ESimSolItexSharp.PushTableInCell(ref _oPdfPTable, oPdfPTable, 0, _oPdfPTable.NumberOfColumns, Element.ALIGN_CENTER, BaseColor.WHITE, false, true);
                #endregion
