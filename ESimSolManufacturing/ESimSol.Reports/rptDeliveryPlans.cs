...
namespace ESimSol.Reports
{
    public class rptDeliveryPlans
    {
        ...
        public byte[] PrepareReport(DeliveryPlan oDeliveryPlan)
        {
            _oDeliveryPlan = oDeliveryPlan;
            _oDeliveryPlans = oDeliveryPlan.DeliveryPlans;
            _oCompany = oDeliveryPlan.Company;
            #region Page Setup
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oDeliveryPlan.BusinessUnit.Name, _oFontStyle));
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oDeliveryPlan.BusinessUnit.PringReportHead, _oFontStyle));
            ...
            _oPdfPCell.Colspan = _nTotalColumn; _oPdfPCell.Border = 0; _oPdfPCell.BorderWidthBottom = 0.5f; _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Delivery Plan @ "+_oDeliveryPlans[0].DeliveryPlanDateInString, _oFontStyle));
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Cutomer", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Priority", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if (_oDeliveryPlans.Count > 0)
            {
                foreach (DeliveryPlan oItem in _oDeliveryPlans)
                {
                    nCount++;
