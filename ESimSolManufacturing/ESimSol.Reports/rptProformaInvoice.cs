...
namespace ESimSol.Reports
{
    ...
    public class rptProformaInvoice
    {
        ...
        private void PrintHeader()
        {
            ...
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.Colspan = 6;
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Consignee/Applicant", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _oPdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Quantity  (" + _oProformaInvoice.UnitName + ")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Unit Price  (" + _oProformaInvoice.CurrencyName + ")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

            _oPdfPCell = new PdfPCell(new Phrase("Amount  (" + _oProformaInvoice.CurrencyName + ")", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            #endregion
            ...
            foreach (ProformaInvoiceDetail oItem in _oProformaInvoiceDetails)
            {
                ...
                _oPdfPCell = new PdfPCell(new Phrase(_oProformaInvoice.CurrencySymbol + " " + Global.MillionFormat(oItem.UnitPrice), _oFontStyle));
                _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);

                _oPdfPCell = new PdfPCell(new Phrase(_oProformaInvoice.CurrencySymbol + " " + Global.MillionFormat(oItem.Amount), _oFontStyle));
                _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            _oPdfPCell = new PdfPCell(new Phrase(_oProformaInvoice.CurrencySymbol + " " + Global.MillionFormat(nTotalValue), _oFontStyle));
            _oPdfPCell.VerticalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
            _oPdfPTable.CompleteRow();
            #endregion
            #endregion
        ...
        private PdfPTable GetRequiredDocumentsTable()
        {
            ...
            foreach (ProformaInvoiceRequiredDoc oItem in _oProformaInvoiceRequiredDocs)
            {
                _oPdfPCell = new PdfPCell(new Phrase(oItem.DocTypeInString, _oFontStyle));
