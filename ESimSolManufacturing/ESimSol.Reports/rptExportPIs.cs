...
namespace ESimSol.Reports
{
    public class rptExportPIs
    {
        ...
        double _nSumExportPIAmount = 0;
        string _sMessage = "";

        #endregion

        public byte[] PrepareReport(List<ExportPI> oExportPIs, string sMessage,Company oCompany)
        {
            ...
            _oDocument.Open();
            _oPdfPTable.SetWidths(new float[] { 55f, 160f, 160f, 160f, 160f, 160f, 160f });
            #endregion
        ...
        private void PrintBody()
        {
            ...
            _oPdfPCell = new PdfPCell(new Phrase("Account of ", _oFontStyle));
            _oPdfPCell.HorizontalAlignment = Element.ALIGN_CENTER; _oPdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY; _oPdfPTable.AddCell(_oPdfPCell);
            ...
            if (_oExportPIs.Count > 0)
            {
                foreach (ExportPI oItem in _oExportPIs)
                {
                    ...
                    _oPdfPCell = new PdfPCell(new Phrase(oItem.ContractorNameCode, _oFontStyle));
                    _oPdfPCell.HorizontalAlignment = Element.ALIGN_LEFT; _oPdfPCell.BackgroundColor = BaseColor.WHITE; _oPdfPTable.AddCell(_oPdfPCell);
